...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT gali dirbti su daugeliu LLM tiekėjų. Ši paslauga bus atsakinga už pokalbių valdymą.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Padėkite mums pritaikyti PrivateGPT jūsų poreikiams. Neprivaloma.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Įjunkite neribotą kiekį įrankių ir sumažinkite žetonų (tokens) naudojimą iki 80 % vienai užklausai — PrivateGPT automatiškai parinks tinkamus įgūdžiai kiekvienai užklausai.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "Pritaikykite savo PrivateGPT instanciją naudodami savo prekės ženklą.",
    },
    chat: {
      title: "Pokalbiai",
    ...
    items: {
      ...
      "display-language": {
        title: "Rodymo kalba",
        description:
          "Pasirinkite pageidaujamą PrivateGPT sąsajos kalbą (jei yra vertimai).",
      },
      logo: {
  ...
  api: {
    title: "API raktai",
    description:
      "API raktai leidžia programiškai pasiekti ir valdyti šią PrivateGPT instanciją.",
    ...
    modal: {
      ...
      helper:
        "Sukūrus API raktą, jį galima naudoti programiškai pasiekti ir konfigūruoti šį PrivateGPT egzempliorių.",
      name: {
        label: "Pavadinimas",
  ...
  llm: {
    title: "LLM pasirinkimas",
    description:
      "Tai jūsų pasirinkto LLM pokalbių ir vektorių kūrimo tiekėjo duomenys ir nustatymai. Svarbu, kad šie raktai būtų aktualūs ir teisingi, kitaip PrivateGPT neveiks tinkamai.",
  ...
  transcription: {
    ...
    "warn-start":
      "Naudojant vietinį Whisper modelį įrenginiuose su ribotu RAM ar CPU kiekiu, PrivateGPT gali sulėtėti apdorojant medijos failus.",
  ...
  embedding: {
    ...
    "desc-end":
      "Vektorių kūrimas (embedding) yra procesas, paverčiantis tekstą skaitmeniniais vektoriais. Šie duomenys reikalingi norint paversti jūsų failus ir užklausas į formatą, kurį PrivateGPT gali apdoroti.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Tai nustatymai, kaip veiks jūsų PrivateGPT instancija. Svarbu, kad šie duomenys būtų aktualūs ir teisingi.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Apsaugokite savo PrivateGPT instanciją slaptažodžiu. Jei jį pamiršite, atkūrimo būdo nėra, todėl būtinai jį išsisaugokite.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie failai bus įkelti į dokumentų procesorių, veikiantį šioje PrivateGPT instancijoje. Šie failai nėra siunčiami ar bendrinami su trečiosiomis šalimis.",
    },
    pinning: {
      what_pinning: "Kas yra dokumento prisegimas?",
      pin_explained_block1:
        "Kai <b>prisegate</b> dokumentą PrivateGPT sistemoje, mes įtrauksime visą dokumento turinį į jūsų užklausos langą, kad jūsų LLM jį visiškai suprastų.",
      pin_explained_block2:
        "Tai geriausiai veikia su <b>didelio konteksto modeliais</b> arba mažais failais, kurie yra labai svarbūs žinių bazei.",
      pin_explained_block3:
        "Jei pagal numatytuosius nustatymus negaunate pageidaujamų atsakymų iš PrivateGPT, prisegimas yra puikus būdas gauti aukštesnės kokybės atsakymus vienu spustelėjimu.",
      accept: "Gerai, supratau",
    },
    watching: {
      what_watching: "Ką daro dokumento stebėjimas?",
      watch_explained_block1:
        "Kai <b>stebite</b> dokumentą PrivateGPT sistemoje, mes <i>automatiškai</i> sinchronizuosime jūsų dokumento turinį iš originalaus šaltinio reguliariais intervalais. Tai automatiškai atnaujins turinį kiekvienoje darbo srityje, kurioje šis failas yra valdomas.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Atmintis",
        placeholder:
          "Pavyzdžiui, vartotojo vardas yra Joe, vartotojas dirba „PrivateGPT“ sistemoje ir pan.",
        create: "Sukurti",
        save: "Įrašyti",
        cancel: "Atšaukti",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Prieš skelbdami elementus, turite prisijungti prie PrivateGPT bendruomenės centro.",
  ...
  telegram: {
    ...
    description:
      "Prisijunkite savo „PrivateGPT“ instanciją prie „Telegram“, kad galėtumėte kalbėti su savo darbo vietomis iš bet kurio įrenginio.",
    setup: {
      step1: {
