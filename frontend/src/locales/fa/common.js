...
const TRANSLATIONS = {
  "onboarding": {
    "survey": {
      ...
      "useCase": "شما از PrivateGPT برای چه منظوری استفاده خواهید کرد؟",
      "useCaseWork": "برای کار",
      "useCasePersonal": "برای استفاده شخصی",
      "useCaseOther": "سایر",
      "comment": "شما از کجا در مورد PrivateGPT مطلع شدید؟",
      ...
      "title": "به PrivateGPT خوش آمدید",
      "description": "ما را در ساخت مدل PrivateGPT متناسب با نیازهای شما یاری دهید. (این بخش اختیاری است)"
    },
    "home": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT می‌تواند با بسیاری از ارائه‌دهندگان مدل‌های زبانی کار کند. این سرویس، مسئولیت انجام مکالمات را بر عهده خواهد داشت."
    },
    "userSetup": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "به اپراتور اجازه دهید تا وظایف تکراری را از طریق چت ایجاد کند (مثلاً: «هر روز کاری در ساعت ۹ صبح، ایمیل‌های من را خلاصه کرده و به من ارسال کنید»). این قابلیت فقط در حالت یک کاربر موجود است."
      }
    },
    "mcp": {
      "title": "سرورهای MCP",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "امکان استفاده از ابزارهای نامحدود و کاهش مصرف توکن تا 80 درصد برای هر پرس و جو را فراهم کنید - PrivateGPT به طور خودکار بهترین مهارت‌ها را برای هر پرس و جو انتخاب می‌کند.",
        "max-tools": {
          "title": "ابزارهای مکس",
  ...
  "api": {
    "title": "کلیدهای API",
    "description": "کلیدهای API به دارنده آن‌ها اجازه می‌دهند به صورت برنامه‌نویسی به این نمونه PrivateGPT دسترسی داشته و آن را مدیریت کنند.",
    ...
    "modal": {
      ...
      "helper": "پس از ایجاد، می‌توان از این کلید API برای دسترسی و پیکربندی برنامه‌نویسی‌شده این نمونه PrivateGPT استفاده کرد.",
      "name": {
        "label": "نام",
  ...
  "llm": {
    ...
    "description": "این‌ها اعتبارنامه‌ها و تنظیمات ارائه‌دهنده مدل زبانی و جاسازی انتخابی شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند در غیر این صورت PrivateGPT به درستی کار نخواهد کرد.",
  ...
  "transcription": {
    ...
    "warn-start": "استفاده از مدل محلی Whisper روی دستگاه‌هایی با RAM یا CPU محدود می‌تواند هنگام پردازش فایل‌های رسانه‌ای باعث توقف PrivateGPT شود.",
  ...
  "embedding": {
    ...
    "desc-end": "جاسازی فرآیند تبدیل متن به بردارها است. این اعتبارنامه‌ها برای تبدیل فایل‌ها و درخواست‌های شما به فرمتی که PrivateGPT بتواند پردازش کند، ضروری هستند.",
    "provider": {
  ...
  "vector": {
    ...
    "description": "این‌ها اعتبارنامه‌ها و تنظیمات نحوه عملکرد نمونه PrivateGPT شما هستند. مهم است که این کلیدها به‌روز و صحیح باشند.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "این پیکربندی شما برای نحوه مدیریت داده‌ها توسط ارائه‌دهندگان شخص ثالث متصل و PrivateGPT است.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "این فایل‌ها در پردازشگر اسناد که روی این نمونه از PrivateGPT در حال اجرا است، بارگذاری خواهند شد. این فایل‌ها به هیچ شخص ثالثی ارسال یا به اشتراک گذاشته نمی‌شوند."
    },
    "pinning": {
      "what_pinning": "مخزن کردن اسناد چیست؟",
      "pin_explained_block1": "هنگامی که شما یک سند را در PrivateGPT \"فیکس\" می‌کنید، محتوای کامل سند را در پنجره دستورالعمل برای مدل زبان بزرگ شما قرار می‌دهیم تا مدل بتواند به طور کامل آن را درک کند.",
      ...
      "pin_explained_block3": "اگر به پاسخ‌های مورد نظر خود از PrivateGPT به طور پیش‌فرض دریافت نمی‌کنید، «پین کردن» یک راه عالی برای دریافت پاسخ‌های با کیفیت بالاتر در یک مرحله است.",
      "accept": "باشه، متوجه شدم."
    },
    "watching": {
      "what_watching": "تماشای یک مستند چه تاثیری دارد؟",
      "watch_explained_block1": "هنگام مشاهده یک سند در PrivateGPT، محتوای سند به طور خودکار از منبع اصلی آن، در فواصل زمانی منظم، همگام‌سازی می‌شود. این کار، به‌طور خودکار محتوا را در هر فضای کاری که این فایل در آن مدیریت می‌شود، به‌روز می‌کند.",
    ...
    "gitea": {
      "name": "ذخیره گیتیا",
      "description": "وارد کردن کل یک مخزن عمومی یا خصوصی از هر نمونه‌ای از گیتیا با یک کلیک.",
      "URL": "آدرس مخزن Gitea",
      "URL_explained": "آدرس مخزن (repository) که می‌خواهید در نمونه Gitea خود جمع‌آوری کنید – از نمونه‌های میزبانی شده نیز پشتیبانی می‌شود.",
      "token": "توکن دسترسی به Gitea",
      "optional": "اختیاری",
      "token_explained": "برای دسترسی به مخازن خصوصی یا مخازنی که در محیط‌هایی با نیاز به احراز هویت قرار دارند، به یک توکن دسترسی نیاز است.",
      "token_explained_start": "بدون",
      "token_explained_link1": "توکن دسترسی",
      "token_explained_end": "فقط گیت‌هایی که نمونه‌گیری از آن‌ها توسط نمونه‌گیتای شما به صورت عمومی در دسترس است، قابل جمع‌آوری هستند.",
      "ignores": "این فایل نادیده گرفته می‌شود.",
      "git_ignore": "لیست در فرمت ‎.gitignore‎ برای نادیده گرفتن فایل‌های خاص هنگام جمع‌آوری. پس از هر آیتمی که می‌خواهید ذخیره کنید، کلید Enter را فشار دهید.",
      "task_explained": "پس از اتمام، تمام فایل‌ها برای قرار دادن در محیط‌های کاری (یا فضاهای کاری) در قسمت انتخاب فایل در سندها، در دسترس خواهند بود.",
      ...
      "token_information": "بدون وارد کردن کلید دسترسی <b>Gitea</b>، این اتصال داده فقط می‌تواند فایل‌ها را از مخازنی که در نمونه Gitea شما به صورت عمومی قابل دسترسی هستند، جمع‌آوری کند."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "حافظه",
        "placeholder": "به عنوان مثال، نام کاربر \"جو\" است، کاربر در \"PrivateGPT\" کار می‌کند و غیره.",
        "create": "ایجاد",
        "save": "ذخیره",
        "cancel": "لغو کردن"
      }
  ...
  "customization": {
    "interface": {
      ...
      "description": "تنظیمات رابط کاربری خود را برای PrivateGPT تعیین کنید."
    },
    "branding": {
      "title": "برندسازی و ارائه خدمات با برچسب سفید",
      "description": "با استفاده از برندسازی سفارشی، نمونه‌ی PrivateGPT خود را با برچسب سفید (White-label) ارائه دهید."
    },
    "chat": {
      "title": "چت",
      "description": "تنظیم ترجیحات چت خود برای PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "display-language": {
        "title": "زبان نمایش",
        "description": "زبان مورد نظر برای نمایش رابط کاربری PrivateGPT را انتخاب کنید - در صورت وجود ترجمه‌ها."
      },
      "logo": {
        "title": "لوگوی برند",
      ...
      "disable-auto-scroll": {
        ...
        "description": "غیرفعال کردن خودکار شدن اسکرول به انتهای چت هنگام دریافت پیام‌های جدید."
      }
    }
  },
  "main-page": {
    ...
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          ...
          "description": "شما باید قبل از انتشار مطالب، با مرکز جامعه PrivateGPT احراز هویت کنید.",
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "از نمونه PrivateGPT خود با رمز عبور محافظت کنید. اگر این رمز را فراموش کنید هیچ روش بازیابی وجود ندارد، پس حتماً این رمز عبور را ذخیره کنید.",
  ...
  "telegram": {
    "title": "ربات تلگرام",
    "description": "با اتصال نمونه PrivateGPT خود به تلگرام، می‌توانید از هر دستگاهی با فضاهای کاری خود گفتگو کنید.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "تنظیم سرویس یا پلتفرم مورد استفاده برای تولید تصاویر از طریق دستور `/img` انجام شود.",
    ...
    "pending": {
      ...
      "description": "ممکن است مدتی طول بکشد. پس از آماده شدن، این اطلاعات در اینجا نمایش داده خواهد شد.",
