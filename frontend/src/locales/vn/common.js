...
const TRANSLATIONS = {
  "onboarding": {
    "survey": {
      ...
      "useCase": "Bạn sẽ sử dụng PrivateGPT để làm gì?",
      "useCaseWork": "Cho công việc",
      "useCasePersonal": "Cho mục đích cá nhân",
      "useCaseOther": "Khác",
      "comment": "Bạn biết đến PrivateGPT như thế nào?",
      ...
      "title": "Chào mừng đến với PrivateGPT",
      "description": "Giúp chúng tôi xây dựng PrivateGPT phù hợp với nhu cầu của bạn. Tùy chọn."
    },
    "home": {
      "getStarted": "Bắt đầu",
      "welcome": "Chào mừng"
    ...
    "llm": {
      "title": "Tùy chọn LLM",
      "description": "PrivateGPT có thể hoạt động với nhiều nhà cung cấp LLM. Đây sẽ là dịch vụ xử lý trò chuyện."
    },
    "userSetup": {
  ...
  "common": {
    ...
    "no": "Không",
    "search": "Tìm kiếm",
    "username_requirements": "Tên người dùng phải có 2-64 ký tự, bắt đầu bằng chữ cái thường và chỉ chứa chữ cái thường, số, dấu gạch dưới, dấu gạch ngang và dấu chấm.",
    "on": "Về",
    "none": "Không",
    "stopped": "Dừng",
    "loading": "Đang tải",
  ...
  "general": {
    ...
    "message": {
      ...
      "body": "các lợi ích của PrivateGPT"
    },
    "delete": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Cho phép đại lý tạo các công việc lặp lại theo lịch trình từ cuộc trò chuyện (ví dụ: \"mỗi ngày làm việc lúc 9 giờ sáng, tóm tắt hộp thư và gửi email cho tôi\"). Chỉ khả dụng trong chế độ sử dụng riêng."
      }
    },
    "mcp": {
      "title": "Máy chủ MCP",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Cho phép sử dụng không giới hạn các công cụ và giảm mức sử dụng token lên đến 80% cho mỗi truy vấn – PrivateGPT tự động chọn các kỹ năng phù hợp nhất cho mỗi yêu cầu.",
        "max-tools": {
          "title": "Công cụ Max",
  ...
  "api": {
    "title": "Khóa API",
    "description": "Khóa API cho phép người sở hữu truy cập và quản lý phiên bản PrivateGPT này theo chương trình.",
    ...
    "modal": {
      ...
      "close": "Đóng",
      "create": "Tạo khóa API",
      "helper": "Sau khi được tạo, khóa API có thể được dùng để truy cập và cấu hình phiên bản PrivateGPT này theo chương trình.",
      "name": {
        "label": "Tên",
  ...
  "llm": {
    "title": "Tùy chọn LLM",
    "description": "Đây là thông tin đăng nhập và cài đặt cho nhà cung cấp LLM trò chuyện & nhúng ưa thích của bạn. Điều quan trọng là các khóa này phải chính xác, nếu không PrivateGPT sẽ không hoạt động đúng.",
  ...
  "transcription": {
    ...
    "warn-start": "Sử dụng mô hình whisper cục bộ trên máy có RAM hoặc CPU hạn chế có thể làm PrivateGPT bị treo khi xử lý tệp media.",
  ...
  "embedding": {
    ...
    "desc-end": "Nhúng là quá trình chuyển đổi văn bản thành vector. Thông tin đăng nhập này cần thiết để chuyển đổi tệp và prompt của bạn thành định dạng mà PrivateGPT có thể sử dụng để xử lý.",
    "provider": {
  ...
  "vector": {
    ...
    "description": "Đây là thông tin đăng nhập và cài đặt cho cách phiên bản PrivateGPT của bạn sẽ hoạt động. Điều quan trọng là các khóa này phải chính xác.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "Đây là cấu hình của bạn về cách các nhà cung cấp bên thứ ba được kết nối và PrivateGPT xử lý dữ liệu của bạn.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Các tệp này sẽ được tải lên trình xử lý tài liệu đang chạy trên phiên bản PrivateGPT này. Các tệp này không được gửi hoặc chia sẻ với bên thứ ba."
    },
    "pinning": {
      "what_pinning": "Ghim tài liệu là gì?",
      "pin_explained_block1": "Khi bạn <b>ghim</b> một tài liệu trong PrivateGPT, chúng tôi sẽ đưa toàn bộ nội dung của tài liệu vào cửa sổ prompt của bạn để LLM hiểu đầy đủ.",
      ...
      "pin_explained_block3": "Nếu bạn không nhận được câu trả lời mong muốn từ PrivateGPT theo mặc định, ghim là một cách tuyệt vời để có được câu trả lời chất lượng cao hơn chỉ với một cú nhấp chuột.",
      "accept": "Ok, tôi hiểu rồi"
    },
    "watching": {
      "what_watching": "Theo dõi tài liệu làm gì?",
      "watch_explained_block1": "Khi bạn <b>theo dõi</b> một tài liệu trong PrivateGPT, chúng tôi sẽ <i>tự động</i> đồng bộ nội dung tài liệu của bạn từ nguồn gốc theo các khoảng thời gian đều đặn. Điều này sẽ tự động cập nhật nội dung trong mọi không gian làm việc nơi tệp này được quản lý.",
    ...
    "gitea": {
      ...
      "description": "Nhập toàn bộ kho lưu trữ công cộng hoặc riêng tư từ bất kỳ phiên bản Gitea nào chỉ bằng một cú nhấp chuột.",
      "URL": "URL kho lưu trữ Gitea",
      "URL_explained": "Địa chỉ URL của kho lưu trữ mà bạn muốn sao chép trên phiên bản Gitea của mình – các phiên bản tự lưu trữ đều được hỗ trợ.",
      "token": "Mật khẩu truy cập Gitea",
      "optional": "tùy chọn",
      "token_explained": "Mã truy cập cần thiết để thu thập các kho lưu trữ riêng tư hoặc các kho lưu trữ trên các máy chủ yêu cầu xác thực.",
      "token_explained_start": "Không có",
      "token_explained_link1": "Mã truy cập",
      "token_explained_end": "Chỉ các kho lưu trữ mà phiên bản Gitea của bạn hiển thị công khai mới có thể được thu thập.",
      "ignores": "Tệp bỏ qua",
      "git_ignore": "Liệt kê định dạng .gitignore để bỏ qua các tệp cụ thể trong quá trình thu thập. Nhấn Enter sau mỗi mục bạn muốn lưu.",
      "task_explained": "Sau khi hoàn thành, tất cả các tệp sẽ có sẵn để gắn vào không gian làm việc trong trình chọn tài liệu.",
      ...
      "token_information": "Nếu không điền thông tin <b>Token truy cập Gitea</b>, kết nối dữ liệu này chỉ có thể thu thập các tệp từ các kho lưu trữ được <b>truy cập công khai</b> trên phiên bản Gitea của bạn."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Bộ nhớ",
        "placeholder": "Ví dụ: Tên người dùng là Joe, người dùng làm việc trên PrivateGPT, v.v.",
        "create": "Tạo",
        "save": "Lưu",
        "cancel": "Hủy"
      }
  ...
  "customization": {
    "interface": {
      ...
      "description": "Đặt tùy chọn giao diện của bạn cho PrivateGPT."
    },
    "branding": {
      "title": "Thương hiệu & Nhãn trắng",
      "description": "Nhãn trắng phiên bản PrivateGPT của bạn với thương hiệu tùy chỉnh."
    },
    "chat": {
      "title": "Trò chuyện",
      "description": "Đặt tùy chọn trò chuyện của bạn cho PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "Chọn ngôn ngữ ưa thích để hiển thị giao diện người dùng của PrivateGPT - khi bản dịch có sẵn."
      },
      "logo": {
      ...
      "disable-auto-scroll": {
        ...
        "description": "Tắt tính năng tự động cuộn xuống cuối cuộc trò chuyện khi nhận được tin nhắn mới."
      }
    }
  },
  "main-page": {
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "Bảo vệ phiên bản PrivateGPT của bạn bằng mật khẩu. Nếu bạn quên mật khẩu này, không có phương pháp khôi phục nên hãy đảm bảo lưu mật khẩu này.",
  ...
  "telegram": {
    "title": "Bot Telegram",
    "description": "Kết nối phiên bản PrivateGPT của bạn với Telegram để bạn có thể trò chuyện với các không gian làm việc của mình từ bất kỳ thiết bị nào.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Cấu hình nhà cung cấp được sử dụng để tạo ảnh từ lệnh `/img`.",
    ...
    "pending": {
      ...
      "description": "Quá trình này có thể mất một khoảng thời gian. Nội dung sẽ hiển thị ngay khi hoàn thành.",
