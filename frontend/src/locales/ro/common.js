...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile."
    },
    "userSetup": {
    ...
    "survey": {
      "title": "Bun venit la PrivateGPT",
      "description": "Ajută-ne să facem PrivateGPT potrivit pentru nevoile tale. Opțional.",
      "email": "Care este adresa ta de email?",
      "useCase": "Pentru ce vei folosi PrivateGPT?",
      "useCaseWork": "Pentru muncă",
      "useCasePersonal": "Pentru uz personal",
      "useCaseOther": "Altele",
      "comment": "De unde ai aflat despre PrivateGPT?",
  ...
  "common": {
    ...
    "no": "Nu",
    "search": "Caută",
    "username_requirements": "Numele de utilizator trebuie să aibă între 2 și 64 de caractere, să înceapă cu o literă mică și să conțină doar litere mici, cifre, liniuțe de subliniere, cratime și puncte.",
    "on": "În",
    "none": "Niciunul",
    "stopped": "Oprit",
    "loading": "Încărcare",
  ...
  "vector": {
    ...
    "description": "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta PrivateGPT. Este important să fie corecte și actuale.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și PrivateGPT gestionează datele tale.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță PrivateGPT. Aceste fișiere nu sunt trimise sau partajate cu o terță parte."
    },
    "pinning": {
      "what_pinning": "Ce este fixarea documentelor?",
      "pin_explained_block1": "Când **fixezi** un document în PrivateGPT, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      "pin_explained_block3": "Dacă nu obții răspunsurile dorite de la PrivateGPT în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      "accept": "Ok, am înțeles"
    },
    "watching": {
      "what_watching": "Ce face vizualizarea unui document?",
      "watch_explained_block1": "Când **urmărești** un document în PrivateGPT, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
    ...
    "gitea": {
      ...
      "description": "Importați un întreg depozit public sau privat dintr orice instanță Gitea printr-o singură acțiune.",
      "URL": "URL-ul Gitea pentru repo",
      "URL_explained": "Adresa URL a depozitului pe care doriți să îl colectați în instanța dumneavoastră Gitea – sunt suportate și instanțele auto-gazduite.",
      "token": "Cheia de acces Gitea",
      "optional": "opțional",
      "token_explained": "Se necesită un token de acces pentru a accesa depozitele private sau depozitele situate pe instanțe care necesită autentificare.",
      "token_explained_start": "Fără",
      "token_explained_link1": "Cheie de acces",
      "token_explained_end": "Doar depozitele pe care instanța dumneavoastră Gitea le expune public pot fi colectate.",
      "ignores": "Fișierul este ignorat",
      "git_ignore": "Creați un fișier în format `.gitignore` pentru a ignora anumite fișiere în timpul colectării. Apăsați tasta Enter după fiecare intrare pe care doriți să o salvați.",
      "task_explained": "Odată ce procesul este finalizat, toate fișierele vor fi disponibile pentru a fi încărcate în spațiile de lucru prin intermediul instrumentului de selectare a documentelor.",
      "branch": "Ramura de rețea din care doriți să colectați fișierele.",
      "branch_loading": "— încărcare ramuri disponibile —",
      "branch_explained": "Ramura din rețea de la care doriți să colectați fișierele.",
      "token_information": "Fără a completa token-ul de acces <b>Gitea</b>, acest conector de date va putea colecta doar fișiere din depozitele care sunt <b>accesibile public</b> în instanța dumneavoastră Gitea."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Memorie",
        "placeholder": "De exemplu, numele utilizatorului este Joe, utilizatorul lucrează cu PrivateGPT, etc.",
        "create": "Creați",
        "save": "Salvați",
        "cancel": "Anula"
      }
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Permite reprezentantului să creeze sarcini programate repetitive direct din aplicație (de exemplu, „în fiecare zi de lucru la ora 9:00, rezumă e-mailurile mele și trimite-mi un raport”). Funcționalitatea este disponibilă doar în modul pentru utilizator unic."
      }
    },
    "mcp": {
      "title": "Servere MCP",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Permite utilizarea nelimitată a instrumentelor și reduce utilizarea token-urilor cu până la 80% pentru fiecare interogare – PrivateGPT selectează automat abilitățile potrivite pentru fiecare solicitare.",
        "max-tools": {
          "title": "Max Tools",
  ...
  "customization": {
    "interface": {
      "title": "Preferințe UI",
      "description": "Setează preferințele UI pentru PrivateGPT."
    },
    "branding": {
      "title": "Branding & White-labeling",
      "description": "Personalizează-ți instanța PrivateGPT cu branding personalizat."
    },
    "chat": {
      "title": "Chat",
      "description": "Setează preferințele de chat pentru PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "Selectează limba preferată pentru a reda interfața PrivateGPT - atunci când traducerile sunt disponibile."
      },
      "logo": {
        "title": "Logo brand",
      ...
      "disable-auto-scroll": {
        ...
        "description": "Dezactivați derularea automată până la sfârșitul conversației atunci când se primesc mesaje noi."
      }
    }
  },
  "api": {
    "title": "Chei API",
    "description": "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță PrivateGPT.",
    ...
    "modal": {
      ...
      "helper": "După creare, cheia API poate fi folosită pentru a accesa și configura programatic această instanță PrivateGPT.",
      "name": {
        "label": "Nume",
  ...
  "llm": {
    "title": "Preferința LLM",
    "description": "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel PrivateGPT nu va funcționa corect.",
  ...
  "transcription": {
    ...
    "warn-start": "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca PrivateGPT la procesarea fișierelor media.",
  ...
  "embedding": {
    ...
    "desc-end": "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care PrivateGPT îl poate utiliza pentru procesare.",
    "provider": {
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "Protejează instanța PrivateGPT cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
  ...
  "telegram": {
    ...
    "description": "Conectați instanța dumneavoastră PrivateGPT cu Telegram, astfel încât să puteți interacționa cu spațiile de lucru de pe orice dispozitiv.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Configurați furnizorul utilizat pentru a genera imagini din comanda `/img`.",
    ...
    "pending": {
      ...
      "description": "Acest lucru poate dura ceva timp. Va apărea aici imediat ce va fi gata.",
