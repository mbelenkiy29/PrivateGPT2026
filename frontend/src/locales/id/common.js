...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT dapat bekerja dengan banyak penyedia LLM. Ini akan menjadi layanan yang menangani obrolan.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Bantu kami membuat PrivateGPT yang sesuai dengan kebutuhan Anda. Opsional.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Aktifkan alat tanpa batas dan kurangi penggunaan token hingga 80% per kueri — PrivateGPT secara otomatis memilih keterampilan yang tepat untuk setiap prompt.",
        "max-tools": {
          title: "Alat Maksimal",
          description:
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "White-label instance PrivateGPT Anda dengan branding kustom.",
    },
    chat: {
      title: "Obrolan",
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Pilih bahasa pilihan untuk merender UI PrivateGPT - saat terjemahan tersedia.",
      },
      logo: {
        title: "Logo Merek",
        description:
  ...
  api: {
    title: "Kunci API",
    description:
      "Kunci API memungkinkan pemegangnya untuk mengakses dan mengelola instance PrivateGPT ini secara terprogram.",
    ...
    modal: {
      ...
      helper:
        "Setelah dibuat, kunci API dapat digunakan untuk mengakses dan mengonfigurasi instance PrivateGPT ini secara terprogram.",
      name: {
        label: "Nama",
  ...
  llm: {
    title: "Preferensi LLM",
    description:
      "Ini adalah kredensial dan pengaturan untuk penyedia obrolan & embedding LLM pilihan Anda. Penting bahwa kunci ini terkini dan benar, atau PrivateGPT tidak akan berfungsi dengan baik.",
  ...
  transcription: {
    ...
    "warn-start":
      "Menggunakan model whisper lokal pada mesin dengan RAM atau CPU terbatas dapat membuat PrivateGPT terhenti saat memproses berkas media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding adalah proses mengubah teks menjadi vektor. Kredensial ini diperlukan untuk mengubah berkas dan prompt Anda menjadi format yang dapat diproses oleh PrivateGPT.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Ini adalah kredensial dan pengaturan untuk bagaimana instance PrivateGPT Anda akan berfungsi. Penting bahwa kunci ini terkini dan benar.",
    provider: {
  ...
  telegram: {
    title: "Bot Telegram",
    description:
      "Hubungkan instance PrivateGPT Anda ke Telegram sehingga Anda dapat mengobrol dengan ruang kerja Anda dari perangkat apa pun.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Lindungi instance PrivateGPT Anda dengan kata sandi. Jika Anda lupa, tidak ada metode pemulihan, jadi pastikan Anda menyimpan kata sandi ini.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Berkas ini akan diunggah ke pemroses dokumen yang berjalan di instance PrivateGPT ini. Berkas ini tidak dikirim atau dibagikan dengan pihak ketiga.",
    },
    pinning: {
      what_pinning: "Apa itu pinning dokumen?",
      pin_explained_block1:
        "Saat Anda <b>pin</b> dokumen di PrivateGPT, kami akan menyuntikkan seluruh konten dokumen ke dalam jendela prompt Anda agar LLM Anda dapat memahaminya sepenuhnya.",
      pin_explained_block2:
        "Ini bekerja paling baik dengan <b>model konteks besar</b> atau berkas kecil yang penting untuk basis pengetahuannya.",
      pin_explained_block3:
        "Jika Anda tidak mendapatkan jawaban yang Anda inginkan dari PrivateGPT secara bawaan, maka pinning adalah cara yang bagus untuk mendapatkan jawaban berkualitas lebih tinggi dalam satu klik.",
      accept: "Oke, mengerti",
    },
    watching: {
      what_watching: "Apa fungsi memantau dokumen?",
      watch_explained_block1:
        "Saat Anda <b>memantau</b> dokumen di PrivateGPT, kami akan <i>secara otomatis</i> menyinkronkan konten dokumen Anda dari sumber aslinya secara berkala. Ini akan secara otomatis memperbarui konten di setiap ruang kerja tempat berkas ini dikelola.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memori",
        placeholder:
          "mis. Nama pengguna adalah Joe, Pengguna bekerja pada PrivateGPT, dll.",
        create: "Buat",
        save: "Simpan",
        cancel: "Batal",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Anda perlu mengautentikasi dengan Community Hub PrivateGPT sebelum mempublikasikan item.",
