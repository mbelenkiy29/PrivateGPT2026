...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLMの設定",
      description:
        "PrivateGPTは多くのLLMプロバイダーと連携できます。これがチャットを処理するサービスになります。",
    },
    userSetup: {
      title: "ユーザー設定",
    ...
    survey: {
      ...
      description:
        "PrivateGPTをあなたのニーズに合わせて構築するためにご協力ください。任意です。",
      email: "メールアドレスは何ですか？",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        title: "知的なスキル選択",
        description:
          "クエリごとに、無制限のツールを使用し、トークン使用量を最大80%削減できます。PrivateGPTは、各プロンプトに対して最適なスキルを自動的に選択します。",
        "max-tools": {
          title: "マックスツールズ",
          description:
  ...
  api: {
    title: "APIキー",
    description:
      "APIキーにより、プログラム経由でこのPrivateGPTインスタンスにアクセスおよび管理できます。",
    link: "APIドキュメントを読む",
    ...
    modal: {
      ...
      create: "APIキーを作成",
      helper:
        "作成したAPIキーは、このPrivateGPTインスタンスにプログラムからアクセスして設定するために使用できます。",
      name: {
        label: "名前",
        placeholder: "本番環境の統合",
  ...
  llm: {
    title: "LLMの設定",
    description:
      "これは、お好みのLLMチャットおよび埋め込みプロバイダー用の認証情報と設定です。これらのキーが最新かつ正確でない場合、PrivateGPTは正しく動作しません。",
    provider: "LLMプロバイダー",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    "warn-start":
      "RAMやCPUが限られたマシンでローカルのWhisperモデルを使用すると、メディアファイルの処理中にPrivateGPTが停止する可能性があります。",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "埋め込みとは、テキストをベクトルに変換するプロセスです。これらの認証情報は、ファイルやプロンプトをPrivateGPTが処理できるフォーマットに変換するために必要です。",
    provider: {
      title: "埋め込みプロバイダー",
    },
  },
  ...
  vector: {
    title: "ベクターデータベース設定",
    description:
      "これは、PrivateGPTインスタンスの動作方法用の認証情報と設定です。これらのキーが最新で正確であることが重要です。",
    provider: {
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "これらのファイルは、このPrivateGPTインスタンス上のドキュメント処理機能にアップロードされます。第三者に送信・共有されることはありません。",
    },
    pinning: {
      what_pinning: "ドキュメントのピン留めとは？",
      pin_explained_block1:
        "PrivateGPTでドキュメントを<b>ピン留め</b>すると、その内容全体がプロンプトウィンドウに挿入され、LLMがしっかり理解できるようになります。",
    ...
    watching: {
      ...
      watch_explained_block1:
        "PrivateGPTでドキュメントを<b>ウォッチ</b>すると、元のソースから定期的に内容が<i>自動的に</i>同期されます。管理しているすべてのワークスペースで内容が自動更新されます。",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "記憶",
        placeholder:
          "例：ユーザー名がジョー、ユーザーが使用しているツールがPrivateGPTなど。",
        create: "作成する",
        save: "保存",
        cancel: "キャンセル",
      },
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "PrivateGPTインスタンスを、独自のブランドでカスタマイズしてください。",
    },
    chat: {
      title: "チャット",
    ...
    items: {
      ...
      "display-language": {
        title: "表示言語",
        description:
          "PrivateGPTのUIを特定の言語で表示するためのオプションを選択してください。翻訳が利用可能な場合にのみ有効です。",
      },
      logo: {
        title: "ブランドロゴ",
        description:
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          title: "本人確認が必要です。",
          description:
            "アイテムを公開する前に、PrivateGPTコミュニティハブで認証する必要があります。",
          button: "コミュニティハブへの接続",
        },
      },
      slash_command: {
  ...
  security: {
    ...
    password: {
      title: "パスワード保護",
      description:
        "PrivateGPTインスタンスをパスワードで保護します。これを忘れた場合、回復方法はないため、このパスワードを必ず保存してください。",
