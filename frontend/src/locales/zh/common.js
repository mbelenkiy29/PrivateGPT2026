...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      "title": "LLM 偏好",
      "description": "PrivateGPT 可以与多家 LLM 提供商合作。这将是处理聊天的服务。"
    },
    "userSetup": {
      "title": "用户设置",
    ...
    "survey": {
      "title": "欢迎使用 PrivateGPT",
      "description": "帮助我们为你的需求打造 PrivateGPT。可选。",
      "email": "你的电子邮件是什么？",
      "useCase": "你将如何使用 PrivateGPT？",
      "useCaseWork": "用于工作",
      "useCasePersonal": "用于个人使用",
      "useCaseOther": "其他",
      "comment": "你是如何听说 PrivateGPT 的？",
  ...
  "common": {
    ...
    "no": "否",
    "search": "搜索",
    "username_requirements": "用户名必须为 2-64 个字符，以小写字母开头，只能包含小写字母、数字、下划线、连字符和句点。",
    "on": "关于",
    "none": "没有",
    "stopped": "停止",
    "loading": "正在加载…",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        "title": "创建计划任务",
        "description": "允许代理人根据聊天内容创建重复的计划任务（例如，“每天工作日的早上9点，总结我的收件箱并发送邮件给我”）。仅适用于单用户模式。"
      }
    },
    "mcp": {
      "title": "MCP 服务器",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        "title": "智能技能选择",
        "description": "实现无限工具和按查询减少高达 80% 的 Token 使用量——PrivateGPT 能够自动选择最合适的技能，以应对每个提示。",
        "max-tools": {
          "title": "麦克斯工具",
  ...
  "customization": {
    "interface": {
      "title": "界面偏好设置",
      "description": "设置您的 PrivateGPT 界面偏好。"
    },
    "branding": {
      "title": "品牌与白标设置",
      "description": "使用自定义品牌对白标您的 PrivateGPT 实例。"
    },
    "chat": {
      "title": "聊天",
      "description": "设置您的 PrivateGPT 聊天偏好。",
      "auto_submit": {
        "title": "自动提交语音输入",
    ...
    "items": {
      ...
      "display-language": {
        "title": "显示语言",
        "description": "选择显示 PrivateGPT 界面所用的语言（若有翻译可用）。"
      },
      "logo": {
        "title": "品牌标志",
  ...
  "api": {
    "title": "API 密钥",
    "description": "API 密钥允许持有者以编程方式访问和管理此 PrivateGPT 实例。",
    "link": "阅读 API 文档",
    ...
    "modal": {
      ...
      "close": "关闭",
      "create": "创建 API 密钥",
      "helper": "创建后，API 密钥可用于以编程方式访问并配置此 PrivateGPT 实例。",
      "name": {
        "label": "名称",
        "placeholder": "生产环境集成",
  ...
  "llm": {
    "title": "LLM 首选项",
    "description": "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，确保这些密钥是最新的和正确的，否则 PrivateGPT 将无法正常运行。",
    "provider": "LLM 提供商",
    "providers": {
      "azure_openai": {
  ...
  "transcription": {
    ...
    "provider": "转录提供商",
    "warn-start": "在 RAM 或 CPU 有限的计算机上使用本地耳语模型可能会在处理媒体文件时停止 PrivateGPT。",
  ...
  "embedding": {
    ...
    "desc-end": "嵌入是将文本转换为矢量的过程。需要这些凭据才能将你的文件和提示转换为 PrivateGPT 可以用来处理的格式。",
    "provider": {
      "title": "嵌入引擎提供商"
    }
  },
  ...
  "vector": {
    "title": "向量数据库",
    "description": "这些是 PrivateGPT 实例如何运行的凭据和设置。重要的是，这些密钥是最新的和正确的。",
    "provider": {
      "title": "向量数据库提供商",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "fetching": "正在获取...",
      "fetch-website": "获取网站",
      "privacy-notice": "这些文件将被上传到此 PrivateGPT 实例上的文档处理器。这些文件不会发送或共享给第三方。"
    },
    "pinning": {
      "what_pinning": "什么是文档固定？",
      "pin_explained_block1": "当您在 PrivateGPT 中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      "pin_explained_block2": "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      "pin_explained_block3": "如果默认情况下无法从 PrivateGPT 获取满意的答案，固定文档是提高答案质量的好方法。",
      "accept": "好的，知道了"
    },
    "watching": {
      "what_watching": "什么是监控文档？",
      "watch_explained_block1": "当您在 PrivateGPT 中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新在所有使用该文档的工作区中的内容。",
    ...
    "gitea": {
      "name": "Gitea 仓库",
      "description": "只需点击，即可从任何 Gitea 实例中导入整个公共或私有的代码仓库。",
      "URL": "Gitea 仓库 URL",
      "URL_explained": "您希望在您的 Gitea 实例上收集的仓库的 URL – 支持自托管实例。",
      "token": "Gitea 访问令牌",
      "optional": "可选",
      "token_explained": "需要访问令牌才能收集私有仓库或在需要身份验证的实例上的仓库。",
      "token_explained_start": "如果没有",
      "token_explained_link1": "访问令牌",
      "token_explained_end": "只有您的 Gitea 实例公开暴露的仓库才能被收集。",
      "ignores": "忽略文件",
      "git_ignore": "使用 `.gitignore` 格式，列出需要忽略的文件，以便在收集时排除这些文件。 在您想要保存的每个条目后按回车键。",
      "task_explained": "一旦完成，所有文件都将可用于在文档选择器中嵌入到工作空间中。",
      "branch": "您希望从哪个分支获取文件。",
      "branch_loading": "– 加载可用的分支 –",
      "branch_explained": "您希望从哪个分支收集文件。",
      "token_information": "如果没有填写 <b>Gitea 访问令牌</b>，此数据连接器只能从您 Gitea 实例上的公开可读的仓库中收集文件。"
    }
  },
  "chat_window": {
    "send_message": "发送消息",
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "需要验证",
          "description": "在发布项目之前，您需要通过 PrivateGPT 社区中心进行验证。",
          "button": "连接到社区中心"
        }
      },
      "slash_command": {
  ...
  "security": {
    ...
    "password": {
      "title": "密码保护",
      "description": "用密码保护你的PrivateGPT实例。如果你忘记了密码，那么没有恢复方法，所以请确保保存这个密码。",
      "password-label": "实例密码"
    },
    "contentGuard": {
      "title": null,
  ...
  "telegram": {
    "title": "Telegram 机器人",
    "description": "将您的 PrivateGPT 实例与 Telegram 连接起来，这样您就可以从任何设备与您的工作空间进行聊天。",
    "setup": {
      "step1": {
