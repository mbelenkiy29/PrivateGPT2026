...
import PrivateGPT from "./media/logo/anything-llm.png";
import PrivateGPTDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(PrivateGPTDark) : setLogo(PrivateGPT);
