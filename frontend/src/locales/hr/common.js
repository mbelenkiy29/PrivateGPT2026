...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM postavka",
      description:
        "PrivateGPT može raditi s mnogim LLM pružateljima usluga. Ovo je usluga koja će upravljati razgovorom.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Pomozite nam da PrivateGPT izgradimo prema vašim potrebama. Neobavezno.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Omogućite neograničen broj alata i smanjite potrošnju tokena do 80% po upitu — PrivateGPT automatski odabire prave vještine za svaki upit.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description:
        "Bijeli žig (white-label) vaše PrivateGPT instance s prilagođenim brendiranjem.",
    },
    chat: {
      title: "Razgovor",
    ...
    items: {
      ...
      "display-language": {
        title: "Jezik prikaza",
        description:
          "Odaberite preferirani jezik za prikaz PrivateGPT sučelja - kada su prijevodi dostupni.",
      },
      logo: {
  ...
  api: {
    title: "API ključevi",
    description:
      "API ključevi omogućuju vlasniku programski pristup i upravljanje ovom PrivateGPT instancom.",
    ...
    modal: {
      ...
      helper:
        "Nakon stvaranja, API ključ se može koristiti za programski pristup i konfiguraciju ove PrivateGPT instance.",
      name: {
        label: "Naziv",
  ...
  llm: {
    title: "LLM postavka",
    description:
      "Ovo su vjerodajnice i postavke za vašeg preferiranog LLM pružatelja usluga razgovora i ugrađivanja (embedding). Važno je da su ovi ključevi ažurni i točni, jer inače PrivateGPT neće funkcionirati ispravno.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korištenje lokalnog whisper modela na uređajima s ograničenom RAM memorijom ili procesorom može zaustaviti PrivateGPT prilikom obrade medijskih datoteka.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Ugrađivanje (embedding) je proces pretvaranja teksta u vektore. Ove vjerodajnice su potrebne za pretvaranje vaših datoteka i upita u format koji PrivateGPT može koristiti za obradu.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Ovo su vjerodajnice i postavke za funkcioniranje vaše PrivateGPT instance. Važno je da su ovi ključevi ažurni i točni.",
    provider: {
  ...
  telegram: {
    title: "Telegram bot",
    description:
      "Povežite svoju PrivateGPT instancu s Telegramom da biste mogli razgovarati sa svojim radnim prostorima s bilo kojeg uređaja.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Zaštitite svoju PrivateGPT instancu lozinkom. Ako je zaboravite, ne postoji način oporavka, tako da svakako spremite ovu lozinku.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ove datoteke bit će prenesene u procesor dokumenata koji radi na ovoj PrivateGPT instanci. Ove datoteke se ne šalju niti dijele s trećim stranama.",
    },
    pinning: {
      what_pinning: "Što je prikvačivanje dokumenata?",
      pin_explained_block1:
        "Kada <b>prikvačite</b> dokument u PrivateGPT-u, ubacit ćemo cijeli sadržaj dokumenta u vaš prozor upita da bi ga vaš LLM potpuno razumio.",
      ...
      pin_explained_block3:
        "Ako ne dobivate željene odgovore od PrivateGPT-a prema zadanim postavkama, prikvačivanje je odličan način za dobivanje kvalitetnijih odgovora jednim klikom.",
      accept: "U redu, razumijem",
    },
    watching: {
      what_watching: "Što radi praćenje dokumenta?",
      watch_explained_block1:
        "Kada <b>pratite</b> dokument u PrivateGPT-u, <i>automatski</i> ćemo sinkronizirati sadržaj vašeg dokumenta iz njegovog izvornog izvora u redovitim intervalima. Ovo će automatski ažurirati sadržaj u svakom radnom prostoru u kojem se ova datoteka upravlja.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memorija",
        placeholder:
          "npr. Korisnikovo ime je Joe, korisnik radi na PrivateGPT-u, itd.",
        create: "Stvori",
        save: "Spremi",
        cancel: "Odustani",
      },
