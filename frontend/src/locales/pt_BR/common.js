...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT funciona com vários provedores de LLM. Este será o serviço que lidará com os chats."
    },
    "userSetup": {
    ...
    "survey": {
      "title": "Bem-vindo ao PrivateGPT",
      "description": "Ajude-nos a melhorar o PrivateGPT. Opcional.",
      "email": "Qual seu email?",
      "useCase": "Como você usará o PrivateGPT?",
      "useCaseWork": "Para trabalho",
      "useCasePersonal": "Uso pessoal",
      "useCaseOther": "Outro",
      "comment": "Como você conheceu o PrivateGPT?",
  ...
  "common": {
    ...
    "no": "Não",
    "search": "Pesquisar",
    "username_requirements": "O nome de usuário deve ter de 2 a 64 caracteres, começar com uma letra minúscula e conter apenas letras minúsculas, números, sublinhados, hífens e pontos.",
    "on": "Sobre",
    "none": "Nenhum",
    "stopped": "Parado",
    "loading": "Carregando",
  ...
  "general": {
    ...
    "message": {
      ...
      "body": "os benefícios do PrivateGPT"
    },
    "delete": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Permita que o agente crie tarefas recorrentes agendadas a partir do chat (por exemplo, \"todos os dias úteis às 9h, resuma minha caixa de entrada e envie um e-mail\"). Disponível apenas no modo para um único usuário."
      }
    },
    "mcp": {
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O PrivateGPT seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  "customization": {
    ...
    "branding": {
      ...
      "description": "Personalize sua instância do PrivateGPT com sua marca."
    },
    "chat": {
      "title": "Chat",
    ...
    "items": {
      ...
      "disable-auto-scroll": {
        ...
        "description": "Desative a rolagem automática até o final da conversa quando novas mensagens forem recebidas."
      }
    }
  },
  "api": {
    ...
    "modal": {
      ...
      "helper": "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do PrivateGPT programaticamente.",
      "name": {
        "label": "Nome",
  ...
  "transcription": {
    ...
    "warn-start": "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o PrivateGPT.",
  ...
  "privacy": {
    ...
    "description": "Configurações de como provedores terceiros e o PrivateGPT lidam com seus dados.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Esses arquivos são enviados ao processador local do PrivateGPT. Não são compartilhados com terceiros."
    },
    "pinning": {
    ...
    "gitea": {
      ...
      "description": "Importe um repositório público ou privado inteiro de qualquer instância do Gitea com apenas um clique.",
      "URL": "URL do repositório Gitea",
      "URL_explained": "URL do repositório que você deseja coletar na sua instância do Gitea – instâncias hospedadas por você são suportadas.",
      "token": "Token de acesso do Gitea",
      "optional": "opcional",
      "token_explained": "Token de acesso necessário para coletar repositórios privados ou repositórios em instâncias que exigem autenticação.",
      "token_explained_start": "Sem",
      "token_explained_link1": "Token de Acesso",
      "token_explained_end": "Somente os repositórios que sua instância do Gitea expõe publicamente podem ser coletados.",
      "ignores": "Arquivo ignorado",
      "git_ignore": "Crie um arquivo no formato \".gitignore\" para especificar quais arquivos devem ser ignorados durante a coleta. Pressione Enter após cada entrada que deseja salvar.",
      "task_explained": "Após a conclusão, todos os arquivos estarão disponíveis para serem incorporados em espaços de trabalho no seletor de documentos.",
      "branch": "A filial de onde você deseja coletar os arquivos.",
      "branch_loading": "– Carregando os ramos disponíveis –",
      "branch_explained": "A(s) filial(is) da qual(es) você deseja coletar arquivos.",
      "token_information": "Sem preencher o token de acesso do <b>Gitea</b>, este conector de dados só poderá coletar arquivos de repositórios que são </b>acessíveis publicamente</b> na sua instância do Gitea."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Memória",
        "placeholder": "por exemplo, o nome do usuário é Joe, o usuário trabalha com PrivateGPT, etc.",
        "create": "Criar",
        "save": "Salvar",
        "cancel": "Cancelar"
      }
  ...
  "telegram": {
    ...
    "description": "Conecte sua instância do PrivateGPT ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Configure o provedor utilizado para gerar imagens a partir do comando `/img`.",
    ...
    "pending": {
      ...
      "description": "Isso pode demorar um pouco. Assim que estiver pronto, aparecerá aqui.",
