...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT ສາມາດເຮັດວຽກຮ່ວມກັບຜູ້ໃຫ້ບໍລິການ LLM ໄດ້ຫຼາຍແຫ່ງ. ນີ້ຈະເປັນບໍລິການທີ່ຈະຈັດການການສົນທະນາ."
    },
    "userSetup": {
      "title": "ຕັ້ງຄ່າຜູ້ໃຊ້",
      ...
      "passwordWarn": "ມັນສຳຄັນຫຼາຍທີ່ຕ້ອງບັນທຶກລະຫັດຜ່ານນີ້ໄວ້ ເພາະບໍ່ມີວິທີການກູ້ຄືນ.",
      ...
      "teamHint": "ໂດຍເລີ່ມຕົ້ນ, ທ່ານຈະເປັນຜູ້ດູແລພຽງຄົນດຽວ. ເມື່ອຕັ້ງຄ່າສຳເລັດແລ້ວ ທ່ານສາມາດສ້າງ ແລະ ເຊີນຄົນອື່ນມາເປັນຜູ້ໃຊ້ ຫຼື ຜູ້ດູແລໄດ້. ຫ້າມເຮັດລະຫັດຜ່ານເສຍ ເພາະມີພຽງຜູ້ດູແລເທົ່ານັ້ນທີ່ສາມາດຕັ້ງລະຫັດຜ່ານໃໝ່ໄດ້."
    },
    "data": {
      "title": "ການຈັດການຂໍ້ມູນ ແລະ ຄວາມເປັນສ່ວນຕົວ",
      "description": "ພວກເຮົາໃຫ້ຄວາມສຳຄັນກັບຄວາມໂປ່ງໃສ ແລະ ການຄວບຄຸມຂໍ້ມູນສ່ວນຕົວຂອງທ່ານ.",
      "settingsHint": "ການຕັ້ງຄ່າເຫຼົ່ານີ້ສາມາດປ່ຽນແປງໄດ້ທຸກເວລາໃນສ່ວນການຕັ້ງຄ່າ."
    },
    "survey": {
      "title": "ຍິນດີຕ້ອນຮັບສູ່ PrivateGPT",
      "description": "ຊ່ວຍພວກເຮົາປັບປຸງ PrivateGPT ໃຫ້ກົງກັບຄວາມຕ້ອງການຂອງທ່ານ. (ບໍ່ບັງຄັບ)",
      "email": "ອີເມວຂອງທ່ານແມ່ນຫຍັງ?",
      "useCase": "ທ່ານຈະໃຊ້ PrivateGPT ເພື່ອຫຍັງ?",
      "useCaseWork": "ສຳລັບວຽກ",
      "useCasePersonal": "ສຳລັບສ່ວນຕົວ",
      "useCaseOther": "ອື່ນໆ",
      "comment": "ທ່ານຮູ້ຈັກ PrivateGPT ໄດ້ແນວໃດ?",
      "commentPlaceholder": "Reddit, Twitter, GitHub, YouTube, ແລະ ອື່ນໆ - ບອກໃຫ້ພວກເຮົາຮູ້ວ່າທ່ານຫາພວກເຮົາເຫັນໄດ້ແນວໃດ!",
      "skip": "ຂ້າມແບບສຳຫຼວດ",
  ...
  "common": {
    ...
    "stopped": "ຢຸດແລ້ວ",
    "search": "ຄົ້ນຫາ",
    "username_requirements": "ຊື່ຜູ້ໃຊ້ຕ້ອງມີ 2-64 ຕົວອັກສອນ, ເລີ່ມຕົ້ນດ້ວຍຕົວພິມນ້ອຍ, ແລະ ປະກອບມີຕົວພິມນ້ອຍ, ຕົວເລກ, ຂີດກ້ອງ (_), ຂີດຕໍ່ (-) ແລະ ຈ້ຳ (.) ເທົ່ານັ້ນ.",
    "loading": "ກຳລັງໂຫຼດ",
    "thinking": "Thinking",
    "working": "Working",
    "searching": "Searching",
  ...
  "home": {
    ...
    "notAssigned": "ຕອນນີ້ທ່ານຍັງບໍ່ໄດ້ຖືກກຳນົດໃຫ້ເຂົ້າຫາພື້ນທີ່ເຮັດວຽກໃດໆ.\nກະລຸນາຕິດຕໍ່ຜູ້ດູແລລະບົບຂອງທ່ານເພື່ອຂໍສິດເຂົ້າໃຊ້ງານ.",
  ...
  "login": {
    ...
    "sign-in": "ປ້ອນຊື່ຜູ້ໃຊ້ ແລະ ລະຫັດຜ່ານຂອງທ່ານເພື່ອເຂົ້າໃຊ້ງານ {{appName}}.",
    "password-reset": {
  ...
  "general": {
    ...
    "message": {
      ...
      "description": "ປັບແຕ່ງຂໍ້ຄວາມທີ່ຈະຖືກແນະນຳໃຫ້ກັບຜູ້ໃຊ້ໃນພື້ນທີ່ເຮັດວຽກຂອງທ່ານ.",
      "add": "ເພີ່ມຂໍ້ຄວາມໃໝ່",
      "save": "ບັນທຶກຂໍ້ຄວາມ",
      "heading": "ອະທິບາຍໃຫ້ຂ້ອຍແນ່",
      "body": "ຂໍ້ດີຂອງ PrivateGPT ແມ່ນຫຍັງ"
    },
    "delete": {
      "title": "ລຶບພື້ນທີ່ເຮັດວຽກ",
      "description": "ລຶບພື້ນທີ່ເຮັດວຽກນີ້ ແລະ ຂໍ້ມູນທັງໝົດ. ສິ່ງນີ້ຈະລຶບພື້ນທີ່ເຮັດວຽກສຳລັບຜູ້ໃຊ້ທຸກຄົນ.",
      "delete": "ລຶບພື້ນທີ່ເຮັດວຽກ",
      "deleting": "ກຳລັງລຶບ...",
      "confirm-start": "ທ່ານກຳລັງຈະລຶບພື້ນທີ່ເຮັດວຽກ",
      "confirm-end": "ທັງໝົດ. ສິ່ງນີ້ຈະເອົາເວກເຕີທັງໝົດອອກຈາກຖານຂໍ້ມູນ.\n\nໄຟລ໌ຕົ້ນສະບັບຈະບໍ່ໄດ້ຮັບຜົນກະທົບ. ການດຳເນີນການນີ້ບໍ່ສາມາດຍົກເລີກໄດ້."
    }
  },
  "chat": {
    "llm": {
      "title": "ຜູ້ໃຫ້ບໍລິການ LLM ຂອງພື້ນທີ່ເຮັດວຽກ",
      "description": "ຜູ້ໃຫ້ບໍລິການ LLM ແລະ ແບບຈຳລອງສະເພາະທີ່ຈະໃຊ້ສຳລັບພື້ນທີ່ເຮັດວຽກນີ້. ໂດຍເລີ່ມຕົ້ນ, ມັນຈະໃຊ້ການຕັ້ງຄ່າລະບົບ.",
      "search": "ຄົ້ນຫາຜູ້ໃຫ້ບໍລິການ LLM ທັງໝົດ"
    },
    "model": {
      "title": "ແບບຈຳລອງການສົນທະນາຂອງພື້ນທີ່ເຮັດວຽກ",
      "description": "ແບບຈຳລອງການສົນທະນາສະເພາະທີ່ຈະໃຊ້ໃນພື້ນທີ່ນີ້. ຖ້າປະວ່າງໄວ້, ຈະໃຊ້ຄ່າເລີ່ມຕົ້ນຂອງລະບົບ."
    },
    "mode": {
      "title": "ໂໝດການສົນທະນາ",
      "automatic": {
        "title": "ເອເຈນ (Agent)",
        "description": "ຈະໃຊ້ເຄື່ອງມືໂດຍອັດຕະໂນມັດຖ້າແບບຈຳລອງ ແລະ ຜູ້ໃຫ້ບໍລິການຮອງຮັບ.<br />ຖ້າບໍ່ຮອງຮັບ, ທ່ານຕ້ອງໃຊ້ຄຳສັ່ງ @agent ເພື່ອໃຊ້ເຄື່ອງມື."
      },
      "chat": {
        "title": "ສົນທະນາ (Chat)",
        "description": "ຈະໃຫ້ຄຳຕອບໂດຍໃຊ້ຄວາມຮູ້ທົ່ວໄປຂອງ LLM <b>ແລະ</b> ຂໍ້ມູນຈາກເອກະສານທີ່ພົບ.<br />ທ່ານຕ້ອງໃຊ້ຄຳສັ່ງ @agent ເພື່ອໃຊ້ເຄື່ອງມື."
      },
      "query": {
        "title": "ສອບຖາມ (Query)",
        "description": "ຈະໃຫ້ຄຳຕອບ <b>ສະເພາະ</b> ເມື່ອພົບຂໍ້ມູນໃນເອກະສານເທົ່ານັ້ນ.<br />ທ່ານຕ້ອງໃຊ້ຄຳສັ່ງ @agent ເພື່ອໃຊ້ເຄື່ອງມື."
      }
    },
    "history": {
      "title": "ປະຫວັດການສົນທະນາ",
      "desc-start": "ຈຳນວນການສົນທະນາກ່ອນໜ້າທີ່ຈະຖືກລວມເຂົ້າໃນຄວາມຈຳໄລຍະສັ້ນສຳລັບການຕອບໂຕ້.",
      "recommend": "ແນະນຳແມ່ນ 20."
    },
    "prompt": {
      "title": "System Prompt",
      "description": "ຄຳສັ່ງຫຼັກທີ່ຈະໃຊ້ໃນພື້ນທີ່ເຮັດວຽກນີ້. ກຳນົດບໍລິບົດ ແລະ ຄຳແນະນຳໃຫ້ AI ສ້າງຄຳຕອບ. ທ່ານຄວນຂຽນຄຳສັ່ງຢ່າງລະອຽດເພື່ອໃຫ້ AI ສ້າງຄຳຕອບທີ່ກົງປະເດັນ ແລະ ຖືກຕ້ອງ.",
      "history": {
        ...
        "clearAllConfirm": "ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການລຶບປະຫວັດທັງໝົດ? ສິ່ງນີ້ບໍ່ສາມາດຍົກເລີກໄດ້.",
        "expand": "ຂະຫຍາຍ"
      }
    },
    "refusal": {
      ...
      "tooltip-description": "ທ່ານຢູ່ໃນໂໝດ Query ເຊິ່ງໃຊ້ຂໍ້ມູນຈາກເອກະສານຂອງທ່ານເທົ່ານັ້ນ. ປ່ຽນເປັນໂໝດ Chat ເພື່ອການສົນທະນາທີ່ຍືດຫຍຸ່ນກວ່າ."
    },
    "temperature": {
      "title": "LLM Temperature",
      "desc-end": "ຄ່າຍິ່ງສູງ ຄວາມຄິດສ້າງສັນຍິ່ງຫຼາຍ. ສຳລັບບາງແບບຈຳລອງ ຖ້າຕັ້ງສູງເກີນໄປອາດເຮັດໃຫ້ຄຳຕອບບໍ່ຕໍ່ເນື່ອງ."
    }
  },
  "vector-workspace": {
    ...
    "snippets": {
      ...
      "description": "ການຕັ້ງຄ່ານີ້ຄວບຄຸມຈຳນວນຂໍ້ຄວາມບໍລິບົດສູງສຸດທີ່ຈະສົ່ງໄປໃຫ້ LLM ໃນແຕ່ລະການສົນທະນາ.",
      "recommend": "ແນະນຳ: 4"
    },
    "doc": {
      "title": "ເກນຄວາມຄືກັນຂອງເອກະສານ",
      "description": "ຄະແນນຄວາມຄືກັນຂັ້ນຕ່ຳທີ່ຕ້ອງການເພື່ອໃຫ້ແຫຼ່ງຂໍ້ມູນຖືກພິຈາລະນາວ່າກ່ຽວຂ້ອງ. ຄ່າຍິ່ງສູງ ແຫຼ່ງຂໍ້ມູນຍິ່ງຕ້ອງຄືກັບຄຳຖາມຫຼາຍຂຶ້ນ.",
      "zero": "ບໍ່ຈຳກັດ",
    ...
    "reset": {
      ...
      "confirm": "ທ່ານກຳລັງຈະລ້າງຖານຂໍ້ມູນເວກເຕີຂອງພື້ນທີ່ນີ້. ສິ່ງນີ້ຈະເອົາເວກເຕີທັງໝົດອອກ.\n\nໄຟລ໌ຕົ້ນສະບັບຈະບໍ່ໄດ້ຮັບຜົນກະທົບ. ການດຳເນີນການນີ້ບໍ່ສາມາດຍົກເລີກໄດ້.",
      "error": "ບໍ່ສາມາດລ້າງຖານຂໍ້ມູນເວກເຕີໄດ້!",
      "success": "ລ້າງຖານຂໍ້ມູນເວກເຕີສຳເລັດແລ້ວ!"
    }
  },
  "agent": {
    "performance-warning": "ປະສິດທິພາບຂອງ LLM ທີ່ບໍ່ຮອງຮັບ tool-calling ໂດຍກົງ ແມ່ນຂຶ້ນກັບຄວາມສາມາດຂອງແບບຈຳລອງ. ບາງຄວາມສາມາດອາດຈະຖືກຈຳກັດ.",
    "provider": {
      "title": "ຜູ້ໃຫ້ບໍລິການ LLM ສຳລັບເອເຈນ",
      "description": "ຜູ້ໃຫ້ບໍລິການ ແລະ ແບບຈຳລອງສະເພາະທີ່ຈະໃຊ້ສຳລັບ @agent ໃນພື້ນທີ່ເຮັດວຽກນີ້."
    },
    "mode": {
      "chat": {
    ...
    "skill": {
      "rag": {
        ...
        "description": "ໃຫ້ເອເຈນໃຊ້ເອກະສານໃນເຄື່ອງເພື່ອຕອບຄຳຖາມ ຫຼື ບອກໃຫ້ເອເຈນ \"ຈົດຈຳ\" ເນື້ອຫາໄວ້."
      },
      "view": {
      ...
      "sql": {
        ...
        "description": "ໃຫ້ເອເຈນສາມາດໃຊ້ SQL ເພື່ອຕອບຄຳຖາມໂດຍການເຊື່ອມຕໍ່ກັບຖານຂໍ້ມູນ SQL ຕ່າງໆ."
      },
      "scheduledJob": {
        "title": "ສ້າງວຽກທີ່ຕັ້ງເວລາ",
        "description": "ໃຫ້ເອເຈນສ້າງວຽກທີ່ເຮັດຊ້ຳໄດ້ຈາກການແຊັດ (ເຊັ່ນ: \"ທຸກໆມື້ເຮັດວຽກຕອນ 9 ໂມງເຊົ້າ ໃຫ້ສະຫຼຸບອີເມວແລ້ວສົ່ງໃຫ້ຂ້ອຍ\"). ໃຊ້ໄດ້ສະເພາະໂໝດຜູ້ໃຊ້ດຽວ."
      },
      "filesystem": {
        "title": "ການເຂົ້າເຖິງລະບົບໄຟລ໌",
        "description": "ໃຫ້ເອເຈນ ອ່ານ, ຂຽນ, ຄົ້ນຫາ ແລະ ຈັດການໄຟລ໌ໃນໂຟນເດີທີ່ກຳນົດ.",
        "learnMore": "ຮຽນຮູ້ເພີ່ມເຕີມກ່ຽວກັບການໃຊ້ທັກສະນີ້",
        "configuration": "ການຕັ້ງຄ່າ",
        "readActions": "ການອ່ານ",
        "writeActions": "ການຂຽນ",
        "warning": "ການເຂົ້າເຖິງລະບົບໄຟລ໌ອາດເປັນອັນຕະລາຍ ເພາະມັນສາມາດແກ້ໄຂ ຫຼື ລຶບໄຟລ໌ໄດ້. ກະລຸນາອ່ານ <a>ຄູ່ມື</a> ກ່ອນເປີດໃຊ້ງານ.",
        "skills": {
          "read-text-file": {
            "title": "ອ່ານໄຟລ໌",
            "description": "ອ່ານເນື້ອຫາໃນໄຟລ໌ (ຂໍ້ຄວາມ, ໂຄ້ດ, PDF, ຮູບພາບ, ແລະ ອື່ນໆ)"
          },
          "read-multiple-files": {
            "title": "ອ່ານຫຼາຍໄຟລ໌",
      ...
      "createFiles": {
        ...
        "description": "ໃຫ້ເອເຈນສ້າງເອກະສານເຊັ່ນ PowerPoint, Excel, Word ແລະ PDF ໄດ້.",
      ...
      "gmail": {
        "title": "GMail",
        "description": "ໃຫ້ເອເຈນເຮັດວຽກກັບ Gmail - ຄົ້ນຫາອີເມວ, ອ່ານຂໍ້ຄວາມ, ຂຽນສະບັບຮ່າງ ແລະ ສົ່ງອີເມວ. <a>ອ່ານຄູ່ມື</a>.",
        "multiUserWarning": "ການເຊື່ອມຕໍ່ Gmail ບໍ່ສາມາດໃຊ້ໄດ້ໃນໂໝດຫຼາຍຜູ້ໃຊ້ເພື່ອຄວາມປອດໄພ.",
        "configuration": "ການຕັ້ງຄ່າ Gmail",
        "deploymentId": "Deployment ID",
        "deploymentIdHelp": "Deployment ID ຈາກ Google Apps Script web app ຂອງທ່ານ",
        "apiKey": "API Key",
        "apiKeyHelp": "API key ທີ່ທ່ານຕັ້ງຄ່າໄວ້ໃນ Google Apps Script",
        "configurationRequired": "ກະລຸນາຕັ້ງຄ່າ Deployment ID ແລະ API Key ເພື່ອເປີດໃຊ້ງານ Gmail.",
      ...
      "googleCalendar": {
        ...
        "description": "ໃຫ້ເອເຈນເຮັດວຽກກັບ Google Calendar - ເບິ່ງປະຕິທິນ, ເຫດການ, ສ້າງ ແລະ ອັບເດດເຫດການ. <a>ອ່ານຄູ່ມື</a>.",
        "multiUserWarning": "ການເຊື່ອມຕໍ່ Google Calendar ບໍ່ສາມາດໃຊ້ໄດ້ໃນໂໝດຫຼາຍຜູ້ໃຊ້.",
        ...
        "configurationRequired": "ກະລຸນາຕັ້ງຄ່າ Deployment ID ແລະ API Key ເພື່ອໃຊ້ງານ.",
        "configured": "ຕັ້ງຄ່າແລ້ວ",
        "searchSkills": "ຄົ້ນຫາທັກສະ...",
        ...
        "skills": {
          ...
          "quickAdd": {
            ...
            "description": "ສ້າງເຫດການຈາກພາສາທຳມະຊາດ (ເຊັ່ນ: 'ປະຊຸມມື້ອື່ນຕອນ 3 ໂມງແລງ')"
          },
          "createEvent": {
            "title": "ສ້າງເຫດການ",
      ...
      "outlook": {
        "title": "Outlook",
        "description": "ໃຫ້ເອເຈນເຮັດວຽກກັບ Microsoft Outlook - ຄົ້ນຫາອີເມວ, ອ່ານຂໍ້ຄວາມ, ສົ່ງອີເມວ ຜ່ານ Microsoft Graph API. <a>ອ່ານຄູ່ມື</a>.",
      ...
      "default_skill": "ໂດຍເລີ່ມຕົ້ນ ທັກສະນີ້ຈະຖືກເປີດໃຊ້ງານ, ແຕ່ທ່ານສາມາດປິດມັນໄດ້ຖ້າບໍ່ຕ້ອງການໃຫ້ເອເຈນໃຊ້."
    },
    "mcp": {
      "title": "ເຊີບເວີ MCP",
      ...
      "tool-warning": "ເພື່ອປະສິດທິພາບທີ່ດີທີ່ສຸດ, ໃຫ້ປິດເຄື່ອງມືທີ່ບໍ່ຈຳເປັນເພື່ອປະຢັດ context.",
      "tools-enabled": "ເຄື່ອງມືທີ່ເປີດໃຊ້ງານ",
      "stop-server": "ຢຸດເຊີບເວີ MCP",
      "start-server": "ເລີ່ມເຊີບເວີ MCP",
      "delete-server": "ລຶບເຊີບເວີ MCP",
      "tool-count-warning": "ເຊີບເວີ MCP ນີ້ມີ <b>{{count}} ເຄື່ອງມືທີ່ເປີດໃຊ້</b> ເຊິ່ງຈະໃຊ້ context ໃນທຸກໆການແຊັດ.<br />ໃຫ້ປິດເຄື່ອງມືທີ່ບໍ່ຈຳເປັນ.",
      "startup-command": "ຄຳສັ່ງເລີ່ມຕົ້ນ",
      "command": "ຄຳສັ່ງ",
      "arguments": "ອາຄິວເມນ (Arguments)",
      "not-running-warning": "ເຊີບເວີ MCP ນີ້ບໍ່ໄດ້ເຮັດວຽກ - ມັນອາດຈະຖືກຢຸດ ຫຼື ມີຂໍ້ຜິດພາດຕອນເລີ່ມຕົ້ນ.",
    ...
    "settings": {
      ...
      "max-tool-calls": {
        ...
        "description": "ຈຳນວນເຄື່ອງມືສູງສຸດທີ່ເອເຈນສາມາດໃຊ້ຕໍ່ເນື່ອງກັນເພື່ອສ້າງຄຳຕອບດຽວ. ສິ່ງນີ້ຊ່ວຍປ້ອງກັນການເຮັດວຽກທີ່ບໍ່ມີວັນສິ້ນສຸດ."
      },
      "intelligent-skill-selection": {
        "title": "ການເລືອກທັກສະແບບອັດສະລິຍະ",
        "description": "ເປີດໃຊ້ເຄື່ອງມືແບບບໍ່ຈຳກັດ ແລະ ຫຼຸດການໃຊ້ token ໄດ້ເຖິງ 80% — PrivateGPT ຈະເລືອກທັກສະທີ່ເໝາະສົມໃຫ້ໂດຍອັດຕະໂນມັດ.",
        "max-tools": {
      ...
      "clarifying-questions": {
        ...
        "beta-badge": "BETA",
        "description": "ເມື່ອເປີດໃຊ້ງານ, ເອເຈນສາມາດຢຸດເພື່ອຖາມຄຳຖາມສັ້ນໆ ຖ້າຄຳສັ່ງຂອງທ່ານບໍ່ຊັດເຈນ.",
        "max-per-turn": {
  ...
  "recorded": {
    "title": "ປະຫວັດການສົນທະນາ",
    "description": "ນີ້ແມ່ນບັນທຶກການສົນທະນາ ແລະ ຂໍ້ຄວາມທັງໝົດທີ່ຖືກສົ່ງໂດຍຜູ້ໃຊ້ ຈັດລຽງຕາມວັນທີ.",
    "export": "ສົ່ງອອກ",
    "table": {
      "id": "ID",
      "by": "ສົ່ງໂດຍ",
  ...
  "customization": {
    "interface": {
      "title": "ການຕັ້ງຄ່າ UI",
      "description": "ຕັ້ງຄ່າ UI ຂອງທ່ານສຳລັບ PrivateGPT."
    },
    "branding": {
      "title": "ແບຣນດິງ & Whitelabeling",
      "description": "ປັບແຕ່ງແບຣນຂອງທ່ານເອງໃນ PrivateGPT."
    },
    "chat": {
      "title": "ການສົນທະນາ",
      "description": "ຕັ້ງຄ່າການສົນທະນາສຳລັບ PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "support-email": {
        ...
        "description": "ຕັ້ງອີເມວຊ່ວຍເຫຼືອເພື່ອໃຫ້ຜູ້ໃຊ້ຕິດຕໍ່ເມື່ອຕ້ອງການຄວາມຊ່ວຍເຫຼືອ."
      },
      "app-name": {
        "title": "ຊື່ແອັບ",
      ...
      "display-language": {
        "title": "ພາສາທີ່ສະແດງ",
        "description": "ເລືອກພາສາທີ່ຈະໃຊ້ໃນ UI ຂອງ PrivateGPT (ເມື່ອມີພາສານັ້ນໃຫ້ເລືອກ)."
      },
      "logo": {
        "title": "ໂລໂກ້ແບຣນ",
      ...
      "render-html": {
        ...
        "description": "ສະແດງຜົນ HTML ໃນຄຳຕອບຂອງ AI.\nສິ່ງນີ້ອາດເຮັດໃຫ້ຄຳຕອບເບິ່ງດີຂຶ້ນ ແຕ່ກໍອາດມີຄວາມສ່ຽງດ້ານຄວາມປອດໄພ."
      },
      "disable-auto-scroll": {
        "title": "ປິດການເຄື່ອນໄหวอัตโนματικ",
        "description": "ຖ້າໄດ້ຮັບຂໍ້ຄວາມໃໝ, ຢ່າໃຫ້ການເຄື່ອນໄหวอัตโนμάតໄປຫາທົ່ວສຸດຂອງການสนทนา។"
      }
    }
  },
  "api": {
    "title": "API Keys",
    "description": "API keys ອະນຸຍາດໃຫ້ເຂົ້າເຖິງ ແລະ ຈັດການ PrivateGPT ຜ່ານການຂຽນໂປຣແກຣມ.",
    "link": "ອ່ານຄູ່ມື API",
    ...
    "modal": {
      ...
      "close": "ປິດ",
      "create": "ສ້າງ API Key",
      "helper": "ເມື່ອສ້າງແລ້ວ ສາມາດໃຊ້ API key ເພື່ອເຂົ້າເຖິງລະບົບ PrivateGPT ນີ້ໄດ້.",
      "name": {
        "label": "ຊື່",
  ...
  "llm": {
    "title": "ການຕັ້ງຄ່າ LLM",
    "description": "ນີ້ແມ່ນຂໍ້ມູນ ແລະ ການຕັ້ງຄ່າສຳລັບຜູ້ໃຫ້ບໍລິການ LLM ແລະ embedding ທີ່ທ່ານເລືອກ. ມັນສຳຄັນຫຼາຍທີ່ຂໍ້ມູນເຫຼົ່ານີ້ຕ້ອງຖືກຕ້ອງ ບໍ່ດັ່ງນັ້ນ PrivateGPT ຈະເຮັດວຽກບໍ່ໄດ້.",
    ...
    "providers": {
      "azure_openai": {
        ...
        "model_type_tooltip": "ຖ້າ Deployment ຂອງທ່ານໃຊ້ແບບຈຳລອງແບບໃຫ້ເຫດຜົນ (o1, o1-mini, o3-mini, ແລະ ອື່ນໆ), ໃຫ້ຕັ້ງເປັນ “Reasoning”. ບໍ່ດັ່ງນັ້ນການແຊັດອາດຈະລົ້ມເຫຼວ.",
  ...
  "model-router": {
    "title": "Model Routers",
    "description": "Model routers ຊ່ວຍໃຫ້ທ່ານກຳນົດກົດເກນເພື່ອສົ່ງຂໍ້ຄວາມໄປຫາຜູ້ໃຫ້ບໍລິການ LLM ແລະ ແບບຈຳລອງທີ່ແຕກຕ່າງກັນໂດຍອັດຕະໂນມັດຕາມເງື່ອນໄຂ.",
    "table": {
      "name": "ຊື່",
    ...
    "empty-description": "ຍັງບໍ່ໄດ້ຕັ້ງຄ່າ model router. ສ້າງອັນໃໝ່ເພື່ອເລີ່ມຕົ້ນ.",
    "new-router-button": "ສ້າງ Router ໃໝ່",
    "delete-confirm": "ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການລຶບ router \"{{name}}\"?\nສິ່ງນີ້ຈະເອົາກົດເກນທັງໝົດອອກ ແລະ ຍົກເລີກການເຊື່ອມຕໍ່ກັບພື້ນທີ່ເຮັດວຽກທີ່ໃຊ້ມັນຢູ່.\n\nການດຳເນີນການນີ້ບໍ່ສາມາດຍົກເລີກໄດ້.",
    ...
    "new-router": {
      ...
      "cooldown-help": "ໄລຍະເວລາທີ່ຈະເກັບການຕັດສິນໃຈໄວ້ກ່ອນຈະກວດສອບກົດເກນໃໝ່. ຕັ້ງເປັນ 0 ເພື່ອປິດການແຄຊ໌.",
    ...
    "rules": {
      ...
      "description": "ກຳນົດກົດເກນເພື່ອເລືອກວ່າຂໍ້ຄວາມໃດຄວນໄປຫາຜູ້ໃຫ້ບໍລິການ ແລະ ແບບຈຳລອງໃດ.",
      ...
      "empty-description": "ເພີ່ມກົດເກນເພື່ອເລີ່ມສົ່ງຂໍ້ຄວາມໄປຫາແບບຈຳລອງທີ່ຕ້ອງການ.",
      "new-rule-button": "ກົດເກນໃໝ່",
      "calculated-section-label": "ກົດເກນແບບຄຳນວນ — ກວດສອບກ່ອນ, ຕາມລຳດັບຄວາມສຳຄັນ",
      "llm-section-label": "ກົດເກນແບບ LLM — ກວດສອບຖ້າບໍ່ມີກົດເກນແບບຄຳນວນໃດກົງ",
      "llm-rule-body": "ຖ້າກົງກັບ <desc>\"{{description}}\"</desc> ໃຫ້ສົ່ງໄປທີ່ <route>{{route}}</route>",
      "calculated-no-conditions": "ບໍ່ມີເງື່ອນໄຂ — ສົ່ງໄປທີ່ <route>{{route}}</route>",
      "calculated-single-condition": "ຖ້າ <prop>{{property}}</prop> {{comparator}} <val>\"{{value}}\"</val> ໃຫ້ສົ່ງໄປທີ່ <route>{{route}}</route>",
      "calculated-multi-condition": "ຖ້າ {{quantifier}} ຂອງ <cond>{{conditions}}</cond> ໃຫ້ສົ່ງໄປທີ່ <route>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete": "ເງື່ອນໄຂທີ {{index}} ບໍ່ສົມບູນ — ກະລຸນາປ້ອນຂໍ້ມູນໃຫ້ຄົບ.",
      "match-description-label": "ຄຳອະທິບາຍການຈັບຄູ່",
      "match-description-placeholder": "ເຊັ່ນ: ຜູ້ໃຊ້ຖາມກ່ຽວກັບກົດໝາຍ, ສັນຍາ ຫຼື ຂໍ້ກຳນົດ",
      "match-description-help": "ອະທິບາຍສະຖານະການທີ່ທ່ານຕ້ອງການໃຫ້ກົດເກນນີ້ເຮັດວຽກ. LLM ຈະເປັນຜູ້ຕັດສິນ.",
      ...
      "type-calculated-description": "ຈັບຄູ່ຕາມຄຸນສົມບັດຂອງຂໍ້ຄວາມ ເຊັ່ນ ເນື້ອຫາ, ຈຳນວນ token ຫຼື ເວລາ.",
      "type-llm-label": "ຈຳແນກໂດຍ LLM",
      "type-llm-description": "ໃຊ້ LLM ເພື່ອແຍກປະເພດຂໍ້ຄວາມຕາມຄຳອະທິບາຍທີ່ທ່ານກຳນົດ.",
      ...
      "help-contains": "ລາຍການທີ່ຂັ້ນດ້ວຍຈ້ຳ (,) — ຈະເຮັດວຽກຖ້າ prompt ມີຄຳໃດຄຳໜຶ່ງ (ບໍ່ສົນໃຈຕົວພິມໃຫຍ່ນ້ອຍ).",
    ...
    "router-selection": {
      ...
      "no-routers-chat": "ບໍ່ມີ router. ສ້າງໄດ້ທີ່ Settings > AI Providers > Model Router.",
    ...
    "chat": {
      ...
      "routed-to-rule": "ສົ່ງໄປຫາ <route>{{model}}</route> ຜ່ານກົດເກນ <rule>{{ruleTitle}}</rule>"
    }
  },
  "transcription": {
    "title": "ການຕັ້ງຄ່າແບບຈຳລອງຖອດຂໍ້ຄວາມ",
    "description": "ນີ້ແມ່ນຂໍ້ມູນສຳລັບຜູ້ໃຫ້ບໍລິການແບບຈຳລອງຖອດຂໍ້ຄວາມ. ຂໍ້ມູນເຫຼົ່ານີ້ຕ້ອງຖືກຕ້ອງເພື່ອໃຫ້ສາມາດຖອດຂໍ້ຄວາມຈາກໄຟລ໌ສື່ ແລະ ສຽງໄດ້.",
    "provider": "ຜູ້ໃຫ້ບໍລິການຖອດຂໍ້ຄວາມ",
    "warn-start": "ການໃຊ້ແບບຈຳລອງ whisper ໃນເຄື່ອງທີ່ມີ RAM ຫຼື CPU ຈຳກັດ ອາດເຮັດໃຫ້ PrivateGPT ເຮັດວຽກຊ້າລົງ.",
    "warn-recommend": "ແນະນຳໃຫ້ມີ RAM ຢ່າງໜ້ອຍ 2GB ແລະ ອັບໂຫຼດໄຟລ໌ທີ່ມີຂະໜາດ <10Mb.",
    "warn-end": "ແບບຈຳລອງໃນຕົວຈະຖືກດາວໂຫຼດໂດຍອັດຕະໂນມັດເມື່ອໃຊ້ງານຄັ້ງທຳອິດ."
  },
  "embedding": {
    "title": "ການຕັ້ງຄ່າ Embedding",
    "desc-start": "ເມື່ອໃຊ້ LLM ທີ່ບໍ່ຮອງຮັບ embedding engine ໃນຕົວ - ທ່ານອາດຈະຕ້ອງລະບຸຂໍ້ມູນສຳລັບການ embedding ຂໍ້ຄວາມເພີ່ມເຕີມ.",
    "desc-end": "Embedding ແມ່ນຂະບວນການປ່ຽນຂໍ້ຄວາມໃຫ້ເປັນເວກເຕີ. ຂໍ້ມູນເຫຼົ່ານີ້ຈຳເປັນເພື່ອປ່ຽນໄຟລ໌ ແລະ prompt ໃຫ້ເປັນຮູບແບບທີ່ PrivateGPT ສາມາດປະມວນຜົນໄດ້.",
    "provider": {
  ...
  "text": {
    ...
    "desc-start": "ບາງຄັ້ງ ທ່ານອາດຕ້ອງການປ່ຽນວິທີການແຍກ ແລະ ແບ່ງຂໍ້ຄວາມກ່ອນຈະນຳເຂົ້າຖານຂໍ້ມູນເວກເຕີ.",
    "desc-end": "ທ່ານຄວນປ່ຽນການຕັ້ງຄ່ານີ້ກໍຕໍ່ເມື່ອທ່ານເຂົ້າໃຈວິທີການເຮັດວຽກ ແລະ ຜົນກະທົບຂອງມັນເທົ່ານັ້ນ.",
    "size": {
    ...
    "overlap": {
      ...
      "description": "ນີ້ແມ່ນຈຳນວນຕົວອັກສອນທີ່ໃຫ້ຊ້ອນກັນລະຫວ່າງສອງ chunk ທີ່ຢູ່ຕິດກັນ."
    }
  },
  "vector": {
    "title": "ຖານຂໍ້ມູນເວກເຕີ",
    "description": "ນີ້ແມ່ນຂໍ້ມູນ ແລະ ການຕັ້ງຄ່າສຳລັບຖານຂໍ້ມູນເວກເຕີ. ມັນສຳຄັນຫຼາຍທີ່ຂໍ້ມູນເຫຼົ່ານີ້ຕ້ອງຖືກຕ້ອງ.",
    "provider": {
  ...
  "embeddable": {
    ...
    "description": "Chat widgets ແມ່ນອິນເຕີເຟດການສົນທະນາທີ່ເປີດໃຫ້ສາທາລະນະ ເຊິ່ງເຊື່ອມຕໍ່ກັບພື້ນທີ່ເຮັດວຽກດຽວ. ສິ່ງນີ້ຊ່ວຍໃຫ້ທ່ານສ້າງພື້ນທີ່ເຮັດວຽກແລ້ວເຜີຍແຜ່ໃຫ້ໂລກເຫັນໄດ້.",
  ...
  "embed-chats": {
    ...
    "export": "ສົ່ງອອກ",
    "description": "ນີ້ແມ່ນບັນທຶກການສົນທະນາທັງໝົດຈາກ widget ຝັງທີ່ທ່ານໄດ້ເຜີຍແຜ່.",
    "table": {
      "embed": "Widget ຝັງ",
      "sender": "ຜູ້ສົ່ງ",
      "message": "ຂໍ້ຄວາມ",
  ...
  "telegram": {
    "title": "Telegram Bot",
    "description": "ເຊື່ອມຕໍ່ PrivateGPT ກັບ Telegram ເພື່ອໃຫ້ທ່ານສາມາດສົນທະນາກັບພື້ນທີ່ເຮັດວຽກໄດ້ຈາກທຸກອຸປະກອນ.",
    "setup": {
      "step1": {
        "title": "ຂັ້ນຕອນທີ 1: ສ້າງ Telegram bot ຂອງທ່ານ",
        "description": "ເປີດ @BotFather ໃນ Telegram, ສົ່ງ <code>/newbot</code> ຫາ <code>@BotFather</code>, ເຮັດຕາມຂັ້ນຕອນ, ແລ້ວກັອບປີ້ API token ມາ.",
        "open-botfather": "ເປີດ BotFather",
        "instruction-1": "1. ເປີດລິ້ງ ຫຼື ສະແກນ QR code",
        "instruction-2": "2. ສົ່ງ <code>/newbot</code> ຫາ <code>@BotFather</code>",
      ...
      "security": {
        ...
        "description": "ເພື່ອຄວາມປອດໄພເພີ່ມເຕີມ, ໃຫ້ຕັ້ງຄ່າເຫຼົ່ານີ້ໃນ @BotFather.",
        "disable-groups": "— ປ້ອງກັນການດຶງ bot ເຂົ້າກຸ່ມ",
        "disable-inline": "— ປ້ອງກັນການໃຊ້ bot ໃນ inline search",
        "obscure-username": "ໃຊ້ຊື່ຜູ້ໃຊ້ bot ທີ່ເດົາໄດ້ຍາກເພື່ອຫຼຸດການຖືກຄົ້ນຫາ"
      },
    ...
    "users": {
      "pending-description": "ຜູ້ໃຊ້ທີ່ລໍຖ້າການຢືນຢັນ. ໃຫ້ກວດເບິ່ງລະຫັດຄູ່ (pairing code) ໃຫ້ກົງກັບທີ່ສະແດງໃນ Telegram ຂອງເຂົາເຈົ້າ.",
      "unknown": "ບໍ່ຮູ້ຈັກ"
    }
  },
  "security": {
    ...
    "multiuser": {
      ...
      "enable": {
        ...
        "description": "ໂດຍເລີ່ມຕົ້ນ ທ່ານຈະເປັນຜູ້ດູແລພຽງຄົນດຽວ. ໃນຖານະຜູ້ດູແລ ທ່ານຕ້ອງສ້າງບັນຊີໃຫ້ຜູ້ໃຊ້ໃໝ່. ຫ້າມເຮັດລະຫັດຜ່ານເສຍ ເພາະມີພຽງຜູ້ດູແລເທົ່ານັ້ນທີ່ຕັ້ງລະຫັດໃໝ່ໄດ້.",
    ...
    "password": {
      ...
      "description": "ປົກປ້ອງ PrivateGPT ຂອງທ່ານດ້ວຍລະຫັດຜ່ານ. ຖ້າທ່ານລືມ ຈະບໍ່ມີວິທີກູ້ຄືນ ດັ່ງນັ້ນກະລຸນາບັນທຶກໄວ້ໃຫ້ດີ.",
  ...
  "event": {
    ...
    "description": "ເບິ່ງການດຳເນີນການ ແລະ ເຫດການທັງໝົດທີ່ເກີດຂຶ້ນໃນລະບົບເພື່ອການກວດສອບ.",
  ...
  "connectors": {
    ...
    "obsidian": {
      ...
      "vault_description": "ເລືອກໂຟນເດີ Obsidian vault ຂອງທ່ານເພື່ອການນຳເຂົ້າໂນ້ດທັງໝົດ.",
      ...
      "vault_warning": "ເພື່ອຫຼີກລ່ຽງຂໍ້ຜິດພາດ, ໃຫ້ແນ່ໃຈວ່າທ່ານບໍ່ໄດ້ເປີດ Obsidian vault ຢູ່."
    },
    "github": {
      "name": "GitHub Repo",
      "description": "ນຳເຂົ້າຄັງເກັບໂຄ້ດ (Repository) ຈາກ GitHub ທັງໝົດໃນຄລິກດຽວ.",
      ...
      "token_explained_middle": ", GitHub API ອາດຈະຈຳກັດຈຳນວນໄຟລ໌ທີ່ສາມາດດຶງໄດ້. ທ່ານສາມາດ ",
      "token_explained_link2": "ສ້າງ Access Token ຊົ່ວຄາວ",
      "token_explained_end": " ເພື່ອຫຼີກລ່ຽງບັນຫານີ້.",
      "ignores": "ໄຟລ໌ທີ່ໃຫ້ຂ້າມ",
      "git_ignore": "ລາຍຊື່ໄຟລ໌ທີ່ບໍ່ຕ້ອງການໃນຮູບແບບ .gitignore. ກົດ Enter ຫຼັງຈາກປ້ອນແຕ່ລະລາຍການ.",
      "task_explained": "ເມື່ອສຳເລັດແລ້ວ, ໄຟລ໌ທັງໝົດຈະພ້ອມໃຫ້ເລືອກໃນໜ້າຈັດການເອກະສານ.",
      "branch": "Branch ທີ່ຕ້ອງການດຶງຂໍ້ມູນ.",
      "branch_loading": "-- ກຳລັງໂຫຼດ branch --",
      "branch_explained": "Branch ທີ່ຕ້ອງການດຶງໄຟລ໌.",
      "token_information": "ຖ້າບໍ່ປ້ອນ <b>GitHub Access Token</b> ຈະສາມາດດຶງໄດ້ສະເພາະໄຟລ໌ໃນ <b>ຊັ້ນເທິງສຸດ</b> ເທົ່ານັ້ນ.",
    ...
    "gitlab": {
      ...
      "token_information": "ຖ້າບໍ່ມີ <b>GitLab Access Token</b> ຈະດຶງໄດ້ສະເພາະໄຟລ໌ <b>ຊັ້ນເທິງສຸດ</b>.",
      "token_personal": "ສ້າງ Personal Access Token ຟຣີໄດ້ທີ່ນີ້."
    },
    "youtube": {
      ...
      "URL_explained_start": "ປ້ອນ URL ວິດີໂອ YouTube ເພື່ອດຶງຄຳບັນຍາຍ. ວິດີໂອຕ້ອງມີ ",
    ...
    "confluence": {
      ...
      "deployment_type_explained": "ເລືອກວ່າ Confluence ຂອງທ່ານເປັນແບບ Cloud ຫຼື ຕິດຕັ້ງເອງ (Self-hosted).",
      ...
      "bypass_ssl_explained": "ເປີດໃຊ້ເພື່ອຂ້າມການກວດສອບ SSL ສຳລັບເຊີບເວີທີ່ຕິດຕັ້ງເອງ.",
      "task_explained": "ເມື່ອສຳເລັດ, ເນື້ອຫາຈະພ້ອມໃຫ້ໃຊ້ງານ."
    },
    "manage": {
      "documents": "ເອກະສານ",
      "data-connectors": "ຕົວເຊື່ອມຕໍ່ຂໍ້ມູນ",
      "desktop-only": "ການແກ້ໄຂການຕັ້ງຄ່າເຫຼົ່ານີ້ສາມາດເຮັດໄດ້ໃນຄອມພິວເຕີເທົ່ານັ້ນ.",
      "dismiss": "ຍົກເລີກ",
      "editing": "ກຳລັງແກ້ໄຂ"
    },
    "directory": {
      ...
      "delete-confirmation": "ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການລຶບໄຟລ໌ ແລະ ໂຟນເດີເຫຼົ່ານີ້?\nສິ່ງນີ້ຈະເອົາໄຟລ໌ອອກຈາກລະບົບ ແລະ ພື້ນທີ່ເຮັດວຽກທັງໝົດໂດຍອັດຕະໂນມັດ.\nການດຳເນີນການນີ້ບໍ່ສາມາດຍົກເລີກໄດ້.",
      "removing-message": "ກຳລັງລຶບ {{count}} ເອກະສານ ແລະ {{folderCount}} ໂຟນເດີ. ກະລຸນາລໍຖ້າ.",
    ...
    "upload": {
      ...
      "processor-offline-desc": "ບໍ່ສາມາດອັບໂຫຼດໄຟລ໌ໄດ້ໃນຕອນນີ້ ເພາະຕົວປະມວນຜົນອອບລາຍຢູ່. ກະລຸນາລອງໃໝ່ພາຍຫຼັງ.",
      ...
      "privacy-notice": "ໄຟລ໌ເຫຼົ່ານີ້ຈະຖືກອັບໂຫຼດໄປທີ່ຕົວປະມວນຜົນໃນ PrivateGPT ນີ້. ຂໍ້ມູນຈະບໍ່ຖືກສົ່ງໃຫ້ບຸກຄົນພາຍນອກ."
    },
    "pinning": {
      "what_pinning": "ການປັກໝຸດເອກະສານແມ່ນຫຍັງ?",
      "pin_explained_block1": "ເມື່ອທ່ານ <b>ປັກໝຸດ</b> ເອກະສານໃນ PrivateGPT ພວກເຮົາຈະໃສ່ເນື້ອຫາທັງໝົດຂອງເອກະສານເຂົ້າໃນ prompt ເພື່ອໃຫ້ LLM ເຂົ້າໃຈໄດ້ຢ່າງຄົບຖ້ວນ.",
      "pin_explained_block2": "ສິ່ງນີ້ຈະເຮັດວຽກໄດ້ດີທີ່ສຸດກັບ <b>ແບບຈຳລອງທີ່ມີ context ຂະໜາດໃຫຍ່</b> ຫຼື ໄຟລ໌ນ້ອຍໆທີ່ສຳຄັນ.",
      "pin_explained_block3": "ຖ້າທ່ານບໍ່ໄດ້ຄຳຕອບທີ່ພໍໃຈ ການປັກໝຸດແມ່ນວິທີທີ່ດີໃນການເພີ່ມຄຸນນະພາບຄຳຕອບ.",
      "accept": "ຕົກລົງ, ເຂົ້າໃຈແລ້ວ"
    },
    "watching": {
      "what_watching": "ການຕິດຕາມ (Watch) ເອກະສານເຮັດຫຍັງໄດ້?",
      "watch_explained_block1": "ເມື່ອທ່ານ <b>ຕິດຕາມ</b> ເອກະສານ ພວກເຮົາຈະ <i>ຊິ້ງ</i> ເນື້ອຫາຈາກແຫຼ່ງຕົ້ນສະບັບໂດຍອັດຕະໂນມັດຕາມໄລຍະເວລາ. ສິ່ງນີ້ຈະອັບເດດເນື້ອຫາໃນທຸກພື້ນທີ່ເຮັດວຽກທີ່ໃຊ້ໄຟລ໌ນີ້.",
      "watch_explained_block2": "ຟີເຈີນີ້ຮອງຮັບສະເພາະເນື້ອຫາອອນລາຍ ແລະ ບໍ່ຮອງຮັບໄຟລ໌ທີ່ອັບໂຫຼດເອງ.",
    ...
    "gitea": {
      "name": "Gitea ບັນຊີ",
      "description": "ຈາກ Gitea ຕົວຢ່າງໃດກໍ່ໄດ້, ສາມາດນຳເອົາບັນຊີທັງໝົດ ຫຼື ເອກະສານເອກະໜິດ ມາໃນການເຄື່ອໄ動ດຽວ.",
      "URL": "URL ຂອງ Gitea",
      "URL_explained": "URL ຂອງ repository ທີ່ເຈົ້າຕ້ອງການລ 수집 ຢູ່លើເວັບໄຊ Gitea – ການນຳ käyttö ຕົວເອງແມ່ນຮັບຮອງ",
      "token": "Token ການເຂົ້າເຖິງ Gitea",
      "optional": "ສາມາດເລືອກໄດ້",
      "token_explained": "ການນຳໃຊ້โทเคನ್‌ເພື່ອສేకະສະຖານທີ່ ຫຼື ສະຖານທີ່ໃນລະບົບທີ່ຕ້ອງການການອະໄດ",
      "token_explained_start": "ໂດຍບໍ່ມີ",
      "token_explained_link1": "โทเคນ ການເຂົ້າถึง",
      "token_explained_end": ", ສິ່ງທີ່ສາມາດກຳນົດໄດ້ ແມ່ນ repository ທີ່ Gitea ຂອງທ່ານເປີດໃຫ້ສາธารະຊົນສາມາດເຂົ້າໄປໃຊ້ໄດ້ເທົ່ານັ້ນ។",
      "ignores": "ไฟล์ละเว้น",
      "git_ignore": "ບັນຊີໃນຮູບແບບ .gitignore ດຳເນີນການບໍ່ໃຫ້ບັນทຶກไฟล์เฉพาะ ໃນຂະบวนການລວບรวม। ແລ້ວ ກົດปุ่ม Enter ຫຼັງຈາກແຕ່ละບັນຊີ ທີ່ເຈົ້າຕ້ອງການບັນทຶກ",
      "task_explained": "ເມື່ອສຳເລັດແລ້ວ, ສਾਰົາເອກະສານຈະສາມາດນຳໃຊ້ໄດ້ເພື່ອຕິດຄліໃນຊ່ອງງານໃນຕົວເລືອກເອກະສານ.",
      "branch": "ສາขา ທີ່ເຈົ້າຕ້ອງການລ 수집 ਫाइल។",
      "branch_loading": "– ສ່ວນສາขาທີ່ມີຢູ່ –",
      "branch_explained": "ສາขาที่คุณຕ້ອງການລ 수 파일을 ලබාទ령",
      "token_information": "ຖ້າບໍ່ໃຊ້ <b>Token ປະຕິหารະ</b>ນີ້, ສະຫນັບສະຫນູນຂໍ້ມູນນີ້ຈະສາມາດรวบรวมไฟล์ໄດ້ພຽງແຕ່ຈາກ repository ທີ່ <b>ສາມາດເບິ່ງໄດ້ສາธารណៈ</b>ໃນຕົວ Gitea ຂອງທ່ານ."
    }
  },
  "chat_window": {
    ...
    "edit_info_user": "\"ສົ່ງ\" ຈະສ້າງຄຳຕອບ AI ໃໝ່. \"ບັນທຶກ\" ຈະອັບເດດສະເພາະຂໍ້ຄວາມຂອງທ່ານ.",
    ...
    "agent_skills_disabled_in_session": "ບໍ່ສາມາດແກ້ໄຂທັກສະໄດ້ໃນຂະນະທີ່ເອເຈນກຳລັງເຮັດວຽກ. ໃຊ້ /exit ເພື່ອຈົບກ່ອນ.",
    "use_agent_session_to_use_tools": "ທ່ານສາມາດໃຊ້ເຄື່ອງມືໃນແຊັດໄດ້ໂດຍການເລີ່ມຕົ້ນດ້ວຍ '@agent' ທາງໜ້າຄຳສັ່ງ.",
    ...
    "memories": {
      ...
      "empty": "ຍັງບໍ່ມີຄວາມຈຳ. ເມື່ອທ່ານສົນທະນາກັບ AI ຫຼາຍຂຶ້ນ ຄວາມຈຳຈະຖືກບັນທຶກ ຫຼື",
      "empty_cta": "ສ້າງຄວາມຈຳໃໝ່",
      "tab_workspace": "ພື້ນທີ່ເຮັດວຽກ",
      "tab_global": "ທົ່ວໂລກ",
      "toggle": {
        "label": "ເປີດໃຊ້ການປັບແຕ່ງສ່ວນຕົວ",
        "description": "ໃຫ້ເອເຈນຈື່ຂໍ້ເທັດຈິງກ່ຽວກັບທ່ານ ຫຼື ພື້ນທີ່ນີ້ເພື່ອໃຊ້ໃນການສົນທະນາ"
      },
      "auto_extraction": {
      ...
      "modal": {
        ...
        "create_description": "ຄວາມຈຳຄວນເປັນຂໍ້ຄວາມສັ້ນໆ ເຊັ່ນ: \"ຜູ້ໃຊ້ມັກ Python ຫຼາຍກວ່າ JavaScript\"",
        "edit_description": "ອັບເດດເນື້ອຫາຄວາມຈຳນີ້.",
        "label": "ຄວາມຈຳ",
        "placeholder": "ເຊັ່ນ: ຜູ້ໃຊ້ຊື່ ສົມໄຊ, ຜູ້ໃຊ້ເຮັດວຽກກ່ຽວກັບ PrivateGPT, ແລະ ອື່ນໆ.",
        "create": "ສ້າງ",
        "save": "ບັນທຶກ",
        "cancel": "ຍົກເລີກ"
      }
  ...
  "community_hub": {
    "publish": {
      "system_prompt": {
        ...
        "success_description": "System Prompt ຂອງທ່ານຖືກເຜີຍແຜ່ໄປທີ່ Community Hub ແລ້ວ!",
        ...
        "tags_description": "ໃຊ້ເພື່ອຊ່ວຍໃນການຄົ້ນຫາ. ເພີ່ມໄດ້ສູງສຸດ 5 ແທັກ. ແທັກລະບໍ່ເກີນ 20 ຕົວອັກສອນ.",
      ...
      "agent_flow": {
        ...
        "privacy_note": "Agent flows ຈະຖືກອັບໂຫຼດເປັນແບບສ່ວນຕົວສະເໝີເພື່ອຄວາມປອດໄພ. ທ່ານສາມາດປ່ຽນເປັນສາທາລະນະໄດ້ໃນພາຍຫຼັງ."
      },
      "slash_command": {
        "success_title": "ສຳເລັດ!",
        ...
        "submitting": "ກຳລັງເຜີຍແຜ່...",
        "prompt_label": "Prompt",
        "prompt_description": "ຄຳສັ່ງທີ່ຈະເຮັດວຽກເມື່ອເອີ້ນໃຊ້ slash command ນີ້.",
        "prompt_placeholder": "ປ້ອນຄຳສັ່ງທີ່ນີ້..."
      },
      "generic": {
        "unauthenticated": {
          "title": "ຕ້ອງຢືນຢັນຕົວຕົນ",
          "description": "ທ່ານຕ້ອງເຊື່ອມຕໍ່ກັບ AnythingLLM Community Hub ກ່ອນຈະເຜີຍແຜ່ລາຍການໄດ້.",
  ...
  "scheduledJobs": {
    ...
    "description": "ສ້າງວຽກ AI ທີ່ເຮັດຊ້ຳຕາມກຳນົດເວລາ. ແຕ່ລະວຽກຈະໃຊ້ຄຳສັ່ງພ້ອມເຄື່ອງມືທີ່ເລືອກ ແລະ ບັນທຶກຜົນໄວ້ໃຫ້ກວດສອບ.",
    "newJob": "ວຽກໃໝ່",
    "loading": "ກຳລັງໂຫຼດ...",
    ...
    "modal": {
      ...
      "toolsDescription": "ເລືອກເຄື່ອງມືເອເຈນທີ່ຈະໃຫ້ວຽກນີ້ໃຊ້. ຖ້າບໍ່ເລືອກ ວຽກຈະເຮັດວຽກໂດຍບໍ່ມີເຄື່ອງມື.",
      "toolsSearch": "ຄົ້ນຫາ",
    ...
    "builder": {
      "fallbackWarning": "ຮູບແບບນີ້ບໍ່ສາມາດແກ້ໄຂຜ່ານຕົວສ້າງໄດ້. ໃຫ້ປ່ຽນເປັນແບບ 'ກຳນົດເອງ' ຫຼື ປ່ຽນຂໍ້ມູນຂ້າງລຸ່ມເພື່ອຂຽນທັບ.",
      "run": "ເຮັດວຽກ",
      "frequency": {
        "minute": "ທຸກໆນາທີ",
        "hour": "ທຸກໆຊົ່ວໂມງ",
  ...
  "imageGeneration": {
    ...
    "pending": {
      ...
      "description": "ນີ້ ສາມາດໃຊ້ເວລາເລັກໜ້ອຍ. ມັນຈະປະກາດຢູ່ທີ່ນີ້ເມື່ອມັນຖືກແກ້ໄຂແລ້ວ",
