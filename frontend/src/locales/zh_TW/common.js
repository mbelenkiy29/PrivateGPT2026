...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      "title": "LLM 偏好",
      "description": "PrivateGPT 可搭配多種 LLM 提供者使用。這項服務會負責處理對話。"
    },
    "userSetup": {
      "title": "使用者設定",
      "description": "設定使用者偏好。",
    ...
    "survey": {
      "title": "歡迎使用 PrivateGPT",
      "description": "協助我們打造更符合需求的 PrivateGPT。此問卷為選填。",
      "email": "您的電子郵件是什麼？",
      "useCase": "您將如何使用 PrivateGPT？",
      "useCaseWork": "用於工作",
      "useCasePersonal": "用於個人使用",
      "useCaseOther": "其他",
      "comment": "您是從哪裡知道 PrivateGPT 的？",
      "commentPlaceholder": "例如 Reddit、Twitter、GitHub、YouTube 等，告訴我們您是怎麼找到 PrivateGPT 的！",
      "skip": "略過問卷",
      "thankYou": "感謝您的回饋！"
    },
    "starterKit": {
  ...
  "common": {
    ...
    "no": "否",
    "search": "搜尋",
    "username_requirements": "使用者名稱必須為64 個字元，以小寫字母開頭，且只能包含小寫字母、數字、底線、連字號和句點。",
    "on": "關於",
    "none": "沒有",
    "stopped": "停止",
    "loading": "載入",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        "title": "建立排程工作",
        "description": "允許經理根據聊天內容，設定重複執行的工作（例如：「每天早上9點，請自動整理我的收件匣並將摘要發送至我的電子郵件」）。僅適用於單一使用者模式。"
      }
    },
    "mcp": {
      "title": "MCP 伺服器",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        "title": "智能技能選擇",
        "description": "啟用無限多個工具，並將每個查詢的 token 使用量最多降低 80% — PrivateGPT 能夠自動選擇最適合的技能，以處理每一個提示。",
        "max-tools": {
          "title": "馬克斯工具",
  ...
  "api": {
    "title": "API 金鑰",
    "description": "API 金鑰可讓持有人透過程式方式存取並管理這個 PrivateGPT 系統。",
    "link": "閱讀 API 文件",
    ...
    "modal": {
      ...
      "close": "關閉",
      "create": "建立 API 金鑰",
      "helper": "建立後，API 金鑰可用於以程式方式存取並設定這個 PrivateGPT 執行個體。",
      "name": {
        "label": "名稱",
        "placeholder": "正式環境整合",
  ...
  "llm": {
    "title": "LLM 偏好設定",
    "description": "這裡設定偏好的 LLM 對話與嵌入提供者之認證資訊與參數。請確認金鑰保持最新且正確，否則 PrivateGPT 可能無法正常運作。",
    "provider": "LLM 提供者",
    "providers": {
      "azure_openai": {
  ...
  "transcription": {
    ...
    "provider": "語音轉錄提供者",
    "warn-start": "在記憶體或 CPU 資源有限的電腦上使用本機 Whisper 模型時，處理媒體檔案可能會讓 PrivateGPT 卡住。",
  ...
  "embedding": {
    ...
    "desc-end": "嵌入是把文字轉成向量的過程。這些認證資訊用來把檔案與提示詞轉成 PrivateGPT 可處理的格式。",
    "provider": {
      "title": "向量嵌入提供者"
    }
  },
  ...
  "vector": {
    "title": "向量資料庫",
    "description": "這裡設定 PrivateGPT 系統運作所需的認證資訊與參數。請務必確認金鑰保持最新且正確。",
    "provider": {
      "title": "向量資料庫提供者",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "fetching": "正在擷取...",
      "fetch-website": "擷取網站",
      "privacy-notice": "這些檔案會上傳到此 PrivateGPT 系統上的文件處理器，不會傳送給或分享給第三方。"
    },
    "pinning": {
      "what_pinning": "什麼是文件釘選？",
      "pin_explained_block1": "當您在 PrivateGPT 中<b>釘選</b>文件時，系統會把整份文件的內容注入提示詞輸入區，讓 LLM 能完整理解。",
      "pin_explained_block2": "這最適合搭配<b>大上下文模型</b>，或對知識庫很重要的小型文件。",
      "pin_explained_block3": "如果 PrivateGPT 在預設情況下給不出想要的答案，釘選文件是快速提升回答品質的好方法。",
      "accept": "好的，明白了"
    },
    "watching": {
      "what_watching": "追蹤文件有何作用？",
      "watch_explained_block1": "當您在 PrivateGPT 中<b>追蹤</b>文件時，系統會<i>自動</i>定期從原始來源同步內容，並更新所有管理這份文件的工作區。",
    ...
    "gitea": {
      "name": "GitEA 儲存庫",
      "description": "只需單擊，即可從任何 Gitea 實例導入整個公共或私有的儲存庫。",
      "URL": "Gitea 儲存庫網址",
      "URL_explained": "您希望在您的 Gitea 實例中收集的倉庫 URL – 支持自建實例。",
      "token": "Gitea 訪問權限代碼",
      "optional": "可選",
      "token_explained": "需要訪問權限才能存取私有倉庫或在需要驗證的伺服器上的倉庫。",
      "token_explained_start": "沒有…",
      "token_explained_link1": "訪問權杖",
      "token_explained_end": "只能從您的 Gitea 實例公開提供的儲存庫中進行收集。",
      "ignores": "忽略檔案",
      "git_ignore": "使用 `.gitignore` 格式列出要排除的檔案，以便在收集時忽略這些檔案。 按下回車鍵後，您可以保存您想要排除的每一項。",
      "task_explained": "完成後，所有檔案都會可供在文件選取器中嵌入到工作空間中使用。",
      "branch": "您希望從哪個分支收集檔案。",
      "branch_loading": "– 正在載入可用的分支 –",
      "branch_explained": "您想要從哪個分支收集檔案。",
      "token_information": "如果沒有填寫 <b>Gitea 存取權杖</b>, 這個資料連接器只能從您 Gitea 實例中<b>公開可讀</b>的儲藏庫收集檔案。"
    }
  },
  "chat_window": {
    "send_message": "傳送訊息",
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "記憶",
        "placeholder": "例如：使用者姓名為 Joe，使用者正在使用 PrivateGPT 等。",
        "create": "創造",
        "save": "儲存",
        "cancel": "取消"
      }
  ...
  "customization": {
    "interface": {
      "title": "介面偏好設定",
      "description": "設定 PrivateGPT 的介面偏好。"
    },
    "branding": {
      "title": "品牌與白標設定",
      "description": "透過自訂品牌元素，將 PrivateGPT 白標化。"
    },
    "chat": {
      "title": "對話",
      "description": "設定 PrivateGPT 的對話偏好。",
      "auto_submit": {
        "title": "語音輸入自動送出",
    ...
    "items": {
      ...
      "display-language": {
        "title": "顯示語言",
        "description": "選擇 PrivateGPT 介面的顯示語言；若已有翻譯就會套用。"
      },
      "logo": {
        "title": "品牌標誌",
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "需要驗證",
          "description": "發布項目前，需先完成 PrivateGPT 社群中心驗證。",
          "button": "連接到社群中心"
        }
      },
      "slash_command": {
  ...
  "security": {
    ...
    "password": {
      "title": "密碼保護",
      "description": "使用密碼保護 PrivateGPT 系統。若忘記此密碼，將無法復原，請務必妥善保存。",
      "password-label": "系統密碼"
    },
    "contentGuard": {
      "title": null,
  ...
  "telegram": {
    "title": "Telegram 機器人",
    "description": "將您的 PrivateGPT 實例連接到 Telegram，以便您可以在任何裝置上與您的工作空間進行對話。",
    "setup": {
      "step1": {
  ...
  "scheduledJobs": {
    ...
    "description": "建立依排程重複執行的 AI 任務。每項工作會執行提示詞、視需要使用工具，並儲存結果供您檢閱。",
    "newJob": "新增工作",
    "loading": "載入中...",
    "emptyTitle": "尚無排程工作",
