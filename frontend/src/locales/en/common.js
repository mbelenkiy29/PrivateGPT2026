const TRANSLATIONS = {
  onboarding: {
    ...
    survey: {
      title: "Welcome to PrivateGPT",
      description: "Help us make PrivateGPT built for your needs. Optional.",
      email: "What's your email?",
      useCase: "What will you use PrivateGPT for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about PrivateGPT?",
      commentPlaceholder:
  ...
  userOnboarding: {
    adminTitle: "Set up your workspace",
    adminDescription:
      "Add your name, name the company workspace, and invite your team before chatting.",
    employeeTitle: "Finish your profile",
    employeeDescription:
      "Tell us who you are. A photo is optional — you can add one later.",
    joining: "You are joining {{workspace}}.",
    profileTitle: "Your profile",
    firstName: "First name",
    lastName: "Last name",
    photo: "Profile photo",
    photoAdd: "Upload a photo",
    photoHint: "Optional. You can change this later in Account.",
    photoSet: "Photo uploaded.",
    photoUploading: "Uploading…",
    photoSaved: "Photo uploaded.",
    photoError: "Could not upload photo.",
    continue: "Continue",
    finish: "Finish setup",
    completeError: "Could not finish onboarding.",
    completeSuccess: "You're in.",
  },
  gettingStarted: {
    title: "Getting started",
    progress: "{{completed}} of {{total}} steps completed",
    allDone: "Your workspace is ready for the team.",
    skip: "Skip for now",
    done: "Done",
    workspace: {
      title: "Create your workspace",
      description:
        "Give your workspace a name and optionally upload a logo. This is how your team will identify the space.",
      save: "Save workspace",
      create: "Create workspace",
      saved: "Workspace saved.",
      saveError: "Could not save workspace.",
      nameRequired: "Enter a workspace name.",
      logo: "Company logo",
      logoAdd: "Upload a logo",
      logoHint: "Optional. Shown on login and in the sidebar.",
      logoSet: "Custom logo is in use. Drop a new file to replace it.",
      logoUploading: "Uploading…",
      logoSaved: "Logo uploaded.",
      logoError: "Could not upload logo.",
    },
    invite: {
      title: "Invite your team",
      description:
        "Create an invite link and send it to teammates. They open it in a browser, set a username and password, and join this workspace.",
      label: "Teammate (optional)",
      labelHint:
        "A name or email for your notes only. Invites are a shareable link — this app does not send email.",
      ...
      needWorkspace: "Save a workspace first so invitees join the right space.",
    },
    tools: {
      title: "Connect your tools",
      description:
        "Optional. Connect Slack, Teams, Telegram, or cloud drives. You can do this later in Settings.",
      slack: "Slack",
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of PrivateGPT",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Enable unlimited tools and cut token usage by up to 80% per query — PrivateGPT automatically selects the right skills for every prompt.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for PrivateGPT.",
    },
    branding: {
    ...
    chat: {
      title: "Chat",
      description: "Set your chat preferences for PrivateGPT.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render PrivateGPT's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this PrivateGPT instance.",
    ...
    modal: {
      ...
      helper:
        "Once created the API key can be used to programmatically access and configure this PrivateGPT instance.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else PrivateGPT will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall PrivateGPT when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which PrivateGPT can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your PrivateGPT instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Connect your PrivateGPT instance to Telegram so you can chat with your workspaces from any device.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your PrivateGPT instance with a password. If you forget this there is no recovery method so ensure you save this password.",
      "password-label": "Instance Password",
    },
    contentGuard: {
      title: "Content policy",
      description:
        "Block pornography, malware links, and phishing before any model or agent sees the message — including private sessions. Admins get a sanitized log (who, when, category) without the message text.",
      toggle: "Scan in-app chats and agents",
      enabledToast: "Content policy is on.",
      disabledToast: "Content policy is off.",
      saveFailed: "Could not update content policy.",
    },
  },
  event: {
    title: "Event Logs",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this PrivateGPT instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in PrivateGPT we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from PrivateGPT by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in PrivateGPT we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
  ...
  chat_window: {
    ...
    incognito_tooltip:
      "Replies stay in this tab and are not written to chat history. The instance still applies content policy, and the model and any tools you run can still see allowed messages.",
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memory",
        placeholder: "e.g. User's name is Joe, User works on PrivateGPT, etc.",
        create: "Create",
        save: "Save",
        cancel: "Cancel",
      },
  ...
  tickets: {
    ...
    empty: {
      ...
      description:
        "Create a ticket, attach Gmail, Notion, or other tools, then hit Start so the workspace agent can do the work.",
    },
    fields: {
      title: "Title",
      description: "Description",
      ...
      toolsHint:
        "Pick tools this ticket may use. Leave empty to use the workspace agent's default skills.",
    },
    placeholders: {
