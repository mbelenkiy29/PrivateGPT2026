...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust."
    },
    "userSetup": {
    ...
    "survey": {
      "title": "Tere tulemast PrivateGPT-i",
      "description": "Aita meil PrivateGPT sinu vajadustele vastavaks kujundada. Valikuline.",
      "email": "Mis on su e-post?",
      "useCase": "Milleks kasutad PrivateGPT-i?",
      "useCaseWork": "Töö jaoks",
      "useCasePersonal": "Isiklikuks kasutuseks",
      "useCaseOther": "Muu",
      "comment": "Kust kuulsid PrivateGPT-ist?",
  ...
  "common": {
    ...
    "no": "Ei",
    "search": "otsing",
    "username_requirements": "Kasutajanimi peab olema 2–64 tähemärki, algama väiketähega ning sisaldama ainult väiketähti, numbreid, alakriipse, sidekriipse ja punkte.",
    "on": "On",
    "none": "Ei",
    "stopped": "Peatas",
    "loading": "Laadimine",
  ...
  "settings": {
    ...
    "mobile-app": "PrivateGPT mobiilversioon",
    "community-hub": {
  ...
  "chat": {
    ...
    "mode": {
      ...
      "query": {
        "title": "Päring",
        "description": "teenib vastuseid <b> ainult, kui dokumendi kontekst on leitav.</b> Vajate kasutama käitu \"@agent\", et kasutada tööriime."
      },
      "automatic": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Lase esindajal luua korduvad, planeeritud ülesanded vestluse kaudu (nt \" iga tööpäeva kell 9 kokkuvõta minu postkasti ja saada mulle e-posti\"). Saadav ainult ühe kasutaja režiimis."
      }
    },
    "mcp": {
      "title": "MCP-serverid",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – PrivateGPT valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          "title": "Max Tools",
  ...
  "customization": {
    "interface": {
      ...
      "description": "Sea PrivateGPT-i UI eelistused."
    },
    "branding": {
      "title": "Bränding ja valgesildistamine",
      "description": "Valgesildista oma PrivateGPT kohandatud brändinguga."
    },
    "chat": {
      "title": "Vestlus",
    ...
    "items": {
      ...
      "display-language": {
        "title": "Kuvakeel",
        "description": "Vali keel, milles PrivateGPT UI kuvatakse (kui tõlge on olemas)."
      },
      "logo": {
        "title": "Brändi logo",
      ...
      "disable-auto-scroll": {
        ...
        "description": "Lülitage automaatne rullimine alla lootes välja, kui saabuvad uued sõnumid."
      }
    }
  },
  "api": {
    "title": "API võtmed",
    "description": "API võtmed võimaldavad programmipõhiselt hallata seda PrivateGPT instantsi.",
    ...
    "modal": {
      ...
      "close": "Sulge",
      "create": "Loo API võti",
      "helper": "Pärast loomist saab API võtit kasutada sellele PrivateGPT-i instantsile programmiga ligi pääsemiseks ja selle seadistamiseks.",
      "name": {
        "label": "Nimi",
  ...
  "llm": {
    "title": "LLM-i eelistus",
    "description": "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul PrivateGPT ei tööta.",
  ...
  "embedding": {
    ...
    "desc-end": "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et PrivateGPT saaks sinu failid ja päringud töödelda.",
    "provider": {
  ...
  "vector": {
    ...
    "description": "Siin on seaded, kuidas PrivateGPT töötab. Vale seadistus võib põhjustada tõrkeid.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "Konfiguratsioon kolmandate osapoolte ja PrivateGPT-i andmekäitluse kohta.",
  ...
  "connectors": {
    ...
    "gitea": {
      "name": "Git repo",
      "description": "Impordige kogu avalik või privaatne Git-repositoor ühe klikiga mis tahes Gitea instantsist.",
      "URL": "Gitea repositooriumi URL",
      "URL_explained": "Repo URL, mida soovite koguda oma Gitea instantsis – toetatakse ka isehoosutatud instansse.",
      "token": "Gitea juurdepääsu token",
      "optional": "valikuline",
      "token_explained": "Avalik juurdepääs nõutakse, et saaksite koguda privaatseid veebikeskusi või veebikeskuseid, mis vajavad autentimist.",
      "token_explained_start": "Ilgata",
      "token_explained_link1": "Ligipääsitoimetunnus",
      "token_explained_end": "Aga ainult need veebipõhised repositorid, mida teie Gitea instants avaldab, saab koguda.",
      "ignores": "Fail ignoreeritakse",
      "git_ignore": "Loole .gitignore formaadis, et eitada konkreetseid failide kogumisel. Vajutage enter pärast iga faili, mida soovite säilitada.",
      "task_explained": "Kui kõik failid on valmis, siis need on saadaval dokumendivaliku funktsiooni kaudu töövälade integreerimiseks.",
      ...
      "token_information": "Kui <b>Gitea andmeühenduse avatuse võti</b> pole täidetud, siis see andmekoguri võib saada failid ainult neist repositoriumidest, mis on <b>avalikult loetavad</b> teie Gitea instantsis."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Mälestus",
        "placeholder": "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes PrivateGPT jne.",
        "create": "Loo",
        "save": "Salvesta",
        "cancel": "Katkuda\nTühista"
      }
  ...
  "telegram": {
    "title": "Telegrami bot",
    "description": "Ühendage oma PrivateGPT instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Konfigureerige pakkuja, mida kasutatakse piltide genereerimiseks käsku `/img` kaudu.",
    ...
    "pending": {
      ...
      "description": "See võib võtta natuke aega. See ilmub siia, niipea kui see on valmis.",
