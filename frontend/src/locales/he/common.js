...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT יכול לעבוד עם ספקי מודלי שפה (LLM) רבים. זה יהיה השירות שיטפל בצ'אט."
    },
    "userSetup": {
      "title": "הגדרת משתמש",
    ...
    "survey": {
      "title": "ברוכים הבאים ל-PrivateGPT",
      "description": "עזרו לנו לבנות את PrivateGPT כך שיתאים לצרכים שלכם. אופציונלי.",
      "email": "מה האימייל שלך?",
      "useCase": "לאיזו מטרה תשתמש ב-PrivateGPT?",
      "useCaseWork": "לעבודה",
      "useCasePersonal": "לשימוש אישי",
      "useCaseOther": "אחר",
      "comment": "איך שמעת על PrivateGPT?",
  ...
  "common": {
    ...
    "no": "לא",
    "search": "חיפוש",
    "username_requirements": "שם המשתמש חייב להיות באורך 2-64 תווים, להתחיל באות קטנה ולהכיל רק אותיות קטנות, מספרים, קווים תחתונים, מקפים ונקודות.",
    "on": "על",
    "none": "אין",
    "stopped": "עצר",
    "loading": "טעינה",
  ...
  "general": {
    ...
    "message": {
      ...
      "save": "שמור הודעות",
      "heading": "הסבר לי",
      "body": "את היתרונות של PrivateGPT"
    },
    "delete": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "אפשר לסוכן ליצור משימות קבועות לפי לוח זמנים, המתבססות על שיחות (לדוגמה: \"כל יום במהלך השבוע בשעה 9 בבוקר, סכם עבורי את תיבת הדואר שלי ושלוח לי מיילים\"). אפשר להשתמש בתכונה זו רק במצב של משתמש אחד."
      }
    },
    "mcp": {
      "title": "שרתי MCP",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "אפשרו שימוש בלתי מוגבל בכלים וצמצום השימוש בטוקנים עד 80% לכל שאילתה – ה-PrivateGPT בוחר באופן אוטומטי את הכישורים המתאימים ביותר לכל בקשה.",
        "max-tools": {
          "title": "כלים של מקס",
  ...
  "customization": {
    "interface": {
      ...
      "description": "הגדר את העדפות ממשק המשתמש שלך עבור PrivateGPT."
    },
    "branding": {
      "title": "מיתוג והתאמה אישית (Whitelabeling)",
      "description": "התאם אישית את מופע ה-PrivateGPT שלך עם מיתוג מותאם אישית."
    },
    "chat": {
      "title": "צ'אט",
      "description": "הגדר את העדפות הצ'אט שלך עבור PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "display-language": {
        "title": "שפת תצוגה",
        "description": "בחר את השפה המועדפת להצגת ממשק המשתמש של PrivateGPT - כאשר תרגומים זמינים."
      },
      "logo": {
        "title": "לוגו מותג",
      ...
      "disable-auto-scroll": {
        ...
        "description": "כבה את הקיפול האוטומטי לסוף החלון כאשר מתקבלות הודעות חדשות."
      }
    }
  },
  "api": {
    "title": "מפתחות API",
    "description": "מפתחות API מאפשרים למחזיק בהם לגשת ולנהל באופן תכנותי את מופע PrivateGPT זה.",
    ...
    "modal": {
      ...
      "close": "סגירה",
      "create": "צור מפתח API",
      "helper": "לאחר יצירתו, ניתן להשתמש במפתח ה-API כדי לגשת למופע PrivateGPT זה ולהגדיר אותו באופן תכנותי.",
      "name": {
        "label": "שם",
  ...
  "llm": {
    "title": "העדפות מודל שפה (LLM)",
    "description": "אלה האישורים וההגדרות עבור ספק הצ'אט וההטמעה המועדף עליך. חשוב שמפתחות אלה יהיו עדכניים ונכונים, אחרת PrivateGPT לא יפעל כראוי.",
    "provider": "ספק LLM",
    "providers": {
      "azure_openai": {
  ...
  "transcription": {
    ...
    "provider": "ספק תמלול",
    "warn-start": "שימוש במודל ה-whisper המקומי על מכונות עם זיכרון RAM או מעבד מוגבלים עלול לגרום להאטה של PrivateGPT בעת עיבוד קובצי מדיה.",
  ...
  "embedding": {
    ...
    "desc-end": "הטמעה היא תהליך של הפיכת טקסט לווקטורים. אישורים אלה נדרשים כדי להפוך את הקבצים וההנחיות שלך לפורמט ש-PrivateGPT יכול להשתמש בו לעיבוד.",
    "provider": {
      "title": "ספק הטמעה"
    }
  },
  ...
  "vector": {
    ...
    "description": "אלה האישורים וההגדרות לאופן פעולת מופע ה-PrivateGPT שלך. חשוב שמפתחות אלה יהיו עדכניים ונכונים.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "זוהי התצורה שלך לאופן שבו ספקים צד שלישי מחוברים ו-PrivateGPT מטפלים בנתונים שלך.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "קבצים אלה יועלו למעבד המסמכים הפועל במופע זה של PrivateGPT. קבצים אלה אינם נשלחים או משותפים עם צד שלישי."
    },
    "pinning": {
      "what_pinning": "מהי הצמדת מסמכים?",
      "pin_explained_block1": "כאשר אתה <b>מצמיד</b> מסמך ב-PrivateGPT, אנו נזריק את כל תוכן המסמך לחלון ההנחיה שלך כדי שמודל השפה שלך יבין אותו במלואו.",
      "pin_explained_block2": "זה עובד בצורה הטובה ביותר עם <b>מודלים בעלי הקשר רחב</b> או קבצים קטנים שהם קריטיים לבסיס הידע שלו.",
      "pin_explained_block3": "אם אינך מקבל את התשובות הרצויות מ-PrivateGPT כברירת מחדל, הצמדה היא דרך מצוינת לקבל תשובות איכותיות יותר בלחיצה אחת.",
      "accept": "אוקיי, הבנתי"
    },
    "watching": {
      "what_watching": "מה עושה מעקב אחר מסמך?",
      "watch_explained_block1": "כאשר אתה <b>עוקב</b> אחר מסמך ב-PrivateGPT, אנו נסנכרן <i>אוטומטית</i> את תוכן המסמך שלך ממקורו המקורי במרווחי זמן קבועים. זה יעדכן אוטומטית את התוכן בכל סביבת עבודה שבה קובץ זה מנוהל.",
    ...
    "gitea": {
      "name": "מאגר ג'יטה",
      "description": "ייבוא שלמא מלא, בין אם הוא ציבורי או פרטי, מכל סביבת Gitea, באמצעות לחיצה אחת בלבד.",
      "URL": "כתובת URL של מאגר ג'יטה",
      "URL_explained": "כתובת ה-URL של המאגר שברצונכם לאסוף בשרת ה-Gitea שלכם – נתמכות גם גרסאות מאוחזות באופן עצמי.",
      "token": "טוקן גיטה",
      "optional": "אופציונלי",
      "token_explained": "סיסמה נדרשת כדי לגשת למאגרים פרטיים או למאגרים במערכות הדורשות אימות.",
      "token_explained_start": "ללא",
      "token_explained_link1": "מפתח גישה",
      "token_explained_end": "ניתן לאסוף רק מאגרים שהאינסטנס של Gitea שלך חושף לציבור.",
      "ignores": "הקובץ מתעלם",
      "git_ignore": "רשימה בפורמט של `.gitignore` כדי להתעלם ממסוימים מהקבצים במהלך איסוף. לחץ על Enter אחרי כל פריט שברצונך לשמור.",
      "task_explained": "לאחר השלמת העיבוד, כל הקבצים יהיו זמינים לשילוב בסביבות עבודה דרך בחירת המסמכים.",
      "branch": "הענף ממנו ברצונך לאסוף קבצים.",
      "branch_loading": "– טעינת הסניפים הזמינים –",
      "branch_explained": "הענף ממנו ברצונך לאסוף קבצים.",
      "token_information": "ללא מילוי של <b>מזהה גישה ל-Gitea</b>, חיבור הנתונים הזה יהיה מסוגל לאסוף קבצים רק ממאגרי קוד שניתן לגשת אליהם באופן <b>ציבורי</b> בתוך המופע של Gitea שלך."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "זיכרון",
        "placeholder": "לדוגמה, שם המשתמש הוא ג'ואי, המשתמש עובד על פלטפורמת PrivateGPT, וכן הלאה.",
        "create": "צור",
        "save": "שמור",
        "cancel": "בטל"
      }
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "נדרש אימות",
          "description": "עליך להתאמת עם מרכז הקהילה של PrivateGPT לפני פרסום פריטים.",
  ...
  "security": {
    ...
    "password": {
      "title": "הגנת סיסמה",
      "description": "הגן על מופע ה-PrivateGPT שלך באמצעות סיסמה. אם תשכח אותה, אין שיטת שחזור, אז ודא שאתה שומר סיסמה זו.",
  ...
  "telegram": {
    "title": "בוט של טלגרם",
    "description": "חברו את ההתקנה של PrivateGPT ל-Telegram, כך שתוכלו לתקשר עם סביבות העבודה שלכם ממכשיר כלשהו.",
    "setup": {
      "step1": {
