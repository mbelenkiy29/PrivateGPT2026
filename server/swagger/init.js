...
const doc = {
  info: {
    version: "1.0.0",
    title: "PrivateGPT Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your PrivateGPT instance. UI supplied by Swagger.io.",
  },
