...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT peut fonctionner avec de nombreux fournisseurs LLM. Ce sera le service qui traitera vos discussions."
    },
    "userSetup": {
    ...
    "data": {
      ...
      "description": "Configurez comment PrivateGPT stocke et traite vos données.",
  ...
  "common": {
    ...
    "no": "Non",
    "search": "Rechercher",
    "username_requirements": "Le nom d'utilisateur doit comporter entre 2 et 64 caractères, commencer par une lettre minuscule et ne contenir que des lettres minuscules, des chiffres, des tirets bas, des tirets et des points.",
    "on": "Sur",
    "none": "Aucun",
    "stopped": "Arrêté",
    "loading": "Chargement",
  ...
  "general": {
    ...
    "message": {
      ...
      "body": "les avantages de PrivateGPT"
    },
    "delete": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Permettez à l'agent de créer des tâches planifiées récurrentes à partir des conversations (par exemple : « tous les jours ouvrables à 9h, résumez ma boîte de réception et envoyez-moi un e-mail »). Fonctionnalité disponible uniquement en mode utilisateur unique."
      }
    },
    "mcp": {
      "title": "Serveurs MCP",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Permettez l'utilisation illimitée d'outils et réduisez la consommation de jetons jusqu'à 80 % par requête – PrivateGPT sélectionne automatiquement les compétences appropriées pour chaque requête.",
        "max-tools": {
          "title": "Max Tools",
  ...
  "api": {
    "title": "Clés API",
    "description": "Les clés API permettent au titulaire d'accéder et de gérer de manière programmatique cette instance PrivateGPT.",
    ...
    "modal": {
      ...
      "helper": "Une fois créée, la clé API peut être utilisée pour accéder à cette instance PrivateGPT et la configurer de manière programmatique.",
      "name": {
        "label": "Nom",
  ...
  "llm": {
    "title": "Préférence LLM",
    "description": "Voici les identifiants et les paramètres de votre fournisseur LLM de chat et d'intégration préféré. Il est important que ces clés soient actuelles et correctes, sinon PrivateGPT ne fonctionnera pas correctement.",
  ...
  "transcription": {
    ...
    "warn-start": "L'utilisation du modèle local whisper sur des machines avec une RAM ou un CPU limités peut bloquer PrivateGPT lors du traitement des fichiers multimédias.",
  ...
  "embedding": {
    ...
    "desc-end": "L'intégration est le processus de transformation du texte en vecteurs. Ces identifiants sont nécessaires pour transformer vos fichiers et invites en un format que PrivateGPT peut utiliser pour traiter.",
    "provider": {
  ...
  "vector": {
    ...
    "description": "Voici les identifiants et les paramètres de fonctionnement de votre instance PrivateGPT. Il est important que ces clés soient actuelles et correctes.",
    "provider": {
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Ces fichiers seront téléchargés sur cette instance PrivateGPT uniquement."
    },
    "pinning": {
      "what_pinning": "Qu'est-ce que l'épinglage de documents ?",
      "pin_explained_block1": "Lorsque vous épinglez un document, PrivateGPT injectera le contenu intégral du document dans votre fenêtre de prompt comme contexte préalable pour chaque interaction.",
    ...
    "watching": {
      ...
      "watch_explained_block1": "Lorsque vous surveillez un document, PrivateGPT re-synchronisera automatiquement le contenu du document depuis sa source de manière périodique.",
    ...
    "gitea": {
      "name": "Dépôt Git",
      "description": "Importer un référentiel public ou privé entier depuis n'importe quelle instance Gitea en un seul clic.",
      "URL": "URL du dépôt Gitea",
      "URL_explained": "URL du dépôt que vous souhaitez récupérer sur votre instance Gitea – les instances auto-hébergées sont prises en charge.",
      "token": "Token d'accès Gitea",
      "optional": "facultatif",
      "token_explained": "Un jeton d'accès est nécessaire pour récupérer les dépôts privés ou les dépôts situés sur des instances qui nécessitent une authentification.",
      "token_explained_start": "Sans",
      "token_explained_link1": "Jeton d'accès",
      "token_explained_end": "Seules les dépôts que votre instance Gitea expose publiquement peuvent être récupérés.",
      "ignores": "Le fichier est ignoré",
      "git_ignore": "Créez un fichier au format \".gitignore\" pour ignorer des fichiers spécifiques lors de la collecte. Appuyez sur Entrée après chaque entrée que vous souhaitez enregistrer.",
      "task_explained": "Une fois terminés, tous les fichiers seront disponibles pour être intégrés dans des espaces de travail via le sélecteur de documents.",
      "branch": "Branche à partir de laquelle vous souhaitez récupérer les fichiers.",
      "branch_loading": "– Chargement des branches disponibles –",
      "branch_explained": "Branche à partir de laquelle vous souhaitez récupérer les fichiers.",
      "token_information": "Sans saisir le jeton d'accès <b>Gitea</b>, ce connecteur de données ne pourra collecter que les fichiers provenant de dépôts accessibles publiquement sur votre instance Gitea."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "Mémoire",
        "placeholder": "Par exemple, le nom de l'utilisateur est Joe, l'utilisateur travaille sur PrivateGPT, etc.",
        "create": "Créer",
        "save": "Enregistrer",
        "cancel": "Annuler"
      }
  ...
  "customization": {
    ...
    "items": {
      ...
      "disable-auto-scroll": {
        ...
        "description": "Désactiver le défilement automatique vers la fin de la conversation lorsqu'un nouveau message est reçu."
      }
    }
  },
  "main-page": {
    ...
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          ...
          "description": "Vous devez vous connecter à votre compte PrivateGPT pour publier sur le Community Hub.",
          "button": "Se connecter"
        }
      },
      "slash_command": {
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "Protégez votre instance PrivateGPT avec un mot de passe. Si vous oubliez ce mot de passe, il n'y a pas de méthode de récupération, donc assurez-vous de le sauvegarder.",
  ...
  "telegram": {
    "title": "Bot Telegram",
    "description": "Connectez votre instance de PrivateGPT à Telegram afin de pouvoir communiquer avec vos espaces de travail depuis n'importe quel appareil.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Configurer le fournisseur utilisé pour générer des images à partir de la commande `/img`.",
    ...
    "pending": {
      ...
      "description": "Cela peut prendre un certain temps. Il apparaîtra ici dès qu'il sera prêt.",
