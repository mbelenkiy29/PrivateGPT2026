...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT ສາມາດເຮັດວຽກຮ່ວມກັບຜູ້ໃຫ້ບໍລິການ LLM ໄດ້ຫຼາຍແຫ່ງ. ນີ້ຈະເປັນບໍລິການທີ່ຈະຈັດການການສົນທະນາ.",
    },
    userSetup: {
      title: "ຕັ້ງຄ່າຜູ້ໃຊ້",
    ...
    survey: {
      ...
      description:
        "ຊ່ວຍພວກເຮົາປັບປຸງ PrivateGPT ໃຫ້ກົງກັບຄວາມຕ້ອງການຂອງທ່ານ. (ບໍ່ບັງຄັບ)",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "ເປີດໃຊ້ເຄື່ອງມືແບບບໍ່ຈຳກັດ ແລະ ຫຼຸດການໃຊ້ token ໄດ້ເຖິງ 80% — PrivateGPT ຈະເລືອກທັກສະທີ່ເໝາະສົມໃຫ້ໂດຍອັດຕະໂນມັດ.",
        "max-tools": {
  ...
  customization: {
    ...
    items: {
      ...
      "display-language": {
        title: "ພາສາທີ່ສະແດງ",
        description:
          "ເລືອກພາສາທີ່ຈະໃຊ້ໃນ UI ຂອງ PrivateGPT (ເມື່ອມີພາສານັ້ນໃຫ້ເລືອກ).",
      },
      logo: {
        title: "ໂລໂກ້ແບຣນ",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys ອະນຸຍາດໃຫ້ເຂົ້າເຖິງ ແລະ ຈັດການ PrivateGPT ຜ່ານການຂຽນໂປຣແກຣມ.",
    link: "ອ່ານຄູ່ມື API",
    ...
    modal: {
      ...
      create: "ສ້າງ API Key",
      helper:
        "ເມື່ອສ້າງແລ້ວ ສາມາດໃຊ້ API key ເພື່ອເຂົ້າເຖິງລະບົບ PrivateGPT ນີ້ໄດ້.",
      name: {
        label: "ຊື່",
  ...
  llm: {
    title: "ການຕັ້ງຄ່າ LLM",
    description:
      "ນີ້ແມ່ນຂໍ້ມູນ ແລະ ການຕັ້ງຄ່າສຳລັບຜູ້ໃຫ້ບໍລິການ LLM ແລະ embedding ທີ່ທ່ານເລືອກ. ມັນສຳຄັນຫຼາຍທີ່ຂໍ້ມູນເຫຼົ່ານີ້ຕ້ອງຖືກຕ້ອງ ບໍ່ດັ່ງນັ້ນ PrivateGPT ຈະເຮັດວຽກບໍ່ໄດ້.",
  ...
  transcription: {
    ...
    "warn-start":
      "ການໃຊ້ແບບຈຳລອງ whisper ໃນເຄື່ອງທີ່ມີ RAM ຫຼື CPU ຈຳກັດ ອາດເຮັດໃຫ້ PrivateGPT ເຮັດວຽກຊ້າລົງ.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding ແມ່ນຂະບວນການປ່ຽນຂໍ້ຄວາມໃຫ້ເປັນເວກເຕີ. ຂໍ້ມູນເຫຼົ່ານີ້ຈຳເປັນເພື່ອປ່ຽນໄຟລ໌ ແລະ prompt ໃຫ້ເປັນຮູບແບບທີ່ PrivateGPT ສາມາດປະມວນຜົນໄດ້.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "ເຊື່ອມຕໍ່ PrivateGPT ກັບ Telegram ເພື່ອໃຫ້ທ່ານສາມາດສົນທະນາກັບພື້ນທີ່ເຮັດວຽກໄດ້ຈາກທຸກອຸປະກອນ.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "ປົກປ້ອງ PrivateGPT ຂອງທ່ານດ້ວຍລະຫັດຜ່ານ. ຖ້າທ່ານລືມ ຈະບໍ່ມີວິທີກູ້ຄືນ ດັ່ງນັ້ນກະລຸນາບັນທຶກໄວ້ໃຫ້ດີ.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "ໄຟລ໌ເຫຼົ່ານີ້ຈະຖືກອັບໂຫຼດໄປທີ່ຕົວປະມວນຜົນໃນ PrivateGPT ນີ້. ຂໍ້ມູນຈະບໍ່ຖືກສົ່ງໃຫ້ບຸກຄົນພາຍນອກ.",
    },
    pinning: {
      what_pinning: "ການປັກໝຸດເອກະສານແມ່ນຫຍັງ?",
      pin_explained_block1:
        "ເມື່ອທ່ານ <b>ປັກໝຸດ</b> ເອກະສານໃນ PrivateGPT ພວກເຮົາຈະໃສ່ເນື້ອຫາທັງໝົດຂອງເອກະສານເຂົ້າໃນ prompt ເພື່ອໃຫ້ LLM ເຂົ້າໃຈໄດ້ຢ່າງຄົບຖ້ວນ.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "ຄວາມຈຳ",
        placeholder:
          "ເຊັ່ນ: ຜູ້ໃຊ້ຊື່ ສົມໄຊ, ຜູ້ໃຊ້ເຮັດວຽກກ່ຽວກັບ PrivateGPT, ແລະ ອື່ນໆ.",
        create: "ສ້າງ",
        save: "ບັນທຶກ",
        cancel: "ຍົກເລີກ",
      },
