...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O PrivateGPT seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do PrivateGPT programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o PrivateGPT.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do PrivateGPT. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memória",
        placeholder:
          "por exemplo, o nome do usuário é Joe, o usuário trabalha com PrivateGPT, etc.",
        create: "Criar",
        save: "Salvar",
        cancel: "Cancelar",
      },
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do PrivateGPT ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
