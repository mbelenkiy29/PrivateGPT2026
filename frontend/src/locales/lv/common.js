...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      ...
      "description": "PrivateGPT var strādāt ar daudziem LLM pakalpojumu sniedzējiem. Šis būs pakalpojums, kas apstrādās sarunas."
    },
    "userSetup": {
    ...
    "survey": {
      "title": "Laipni lūgti PrivateGPT",
      "description": "Palīdziet mums veidot PrivateGPT atbilstoši jūsu vajadzībām. Neobligāti.",
      "email": "Kāds ir jūsu e-pasts?",
      "useCase": "Kam izmantosiet PrivateGPT?",
      "useCaseWork": "Darbam",
      "useCasePersonal": "Personīgai lietošanai",
      "useCaseOther": "Citam nolūkam",
      "comment": "Kā jūs uzzinājāt par PrivateGPT?",
  ...
  "common": {
    ...
    "no": "Nē",
    "search": "Meklēšana",
    "username_requirements": "Lietotājvārdam jābūt 2–64 rakstzīmju garam, jāsākas ar mazo burtu un jāsatur tikai mazie burti, cipari, apakšsvītras, domuzīmes un punkti.",
    "on": "Par",
    "none": "Nav",
    "stopped": "Apstājās",
    "loading": "Ielāde",
  ...
  "settings": {
    ...
    "mobile-app": "PrivateGPT mobilā versija",
    "community-hub": {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "Ļauj aģentam izveidot atkārtotus plānotus darbus no čata (piemēram, \"katru darba dienu plkst. 9:00 nosūtīt man savu e-pasta kopsavilkumu un nosūtīt ziņu\"). Pieejams tikai vienam lietotājam."
      }
    },
    "mcp": {
      "title": "MCP serveri",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "Ievērojiet neierobežotu rīku un \"cut token\" izmantošanas samazinājumu līdz 80% uz katru pieprasījumu – PrivateGPT automātiski izvēlas piemērotākās prasmes katram pieprasījumam.",
        "max-tools": {
          "title": "Max Tools",
  ...
  "customization": {
    "interface": {
      ...
      "description": "Iestatiet savas UI preferences PrivateGPT."
    },
    "branding": {
      "title": "Zīmolrade un identitāte",
      "description": "Pielāgojiet savu PrivateGPT instanci ar pielāgotu zīmolradi."
    },
    "chat": {
      "title": "Saruna",
      "description": "Iestatiet savas sarunas preferences PrivateGPT.",
      "auto_submit": {
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "Izvēlieties vēlamo valodu PrivateGPT lietotāja saskarnei - kad pieejami tulkojumi."
      },
      "logo": {
      ...
      "disable-auto-scroll": {
        ...
        "description": "Atstāviet automātisko skrološanu uz sarunas beigām, kad saņemts jauns sūtījums."
      }
    }
  },
  "api": {
    "title": "API atslēgas",
    "description": "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo PrivateGPT instanci.",
    ...
    "modal": {
      ...
      "helper": "Pēc izveides API atslēgu var izmantot, lai programmatiski piekļūtu šai PrivateGPT instancei un to konfigurētu.",
      "name": {
        "label": "Nosaukums",
  ...
  "llm": {
    "title": "LLM preferences",
    "description": "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā PrivateGPT nedarbosies pareizi.",
  ...
  "transcription": {
    ...
    "warn-start": "Izmantojot lokālo whisper modeli iekārtās ar ierobežotu RAM vai CPU var apstādināt PrivateGPT, apstrādājot multivides failus.",
  ...
  "embedding": {
    ...
    "desc-end": "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru PrivateGPT var izmantot apstrādei.",
    "provider": {
  ...
  "vector": {
    ...
    "description": "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu PrivateGPT instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    "provider": {
  ...
  "privacy": {
    ...
    "description": "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un PrivateGPT apstrādā jūsu datus.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā PrivateGPT instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi."
    },
    "pinning": {
      "what_pinning": "Kas ir dokumentu piespraušana?",
      "pin_explained_block1": "Kad jūs <b>piespraudiet</b> dokumentu PrivateGPT, mēs ievietosim visu dokumenta saturu jūsu uzvednes logā, lai jūsu LLM to pilnībā saprastu.",
      ...
      "pin_explained_block3": "Ja jūs nesaņemat vēlamās atbildes no PrivateGPT pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      "accept": "Labi, sapratu"
    },
    "watching": {
      "what_watching": "Ko dara dokumenta novērošana?",
      "watch_explained_block1": "Kad jūs <b>novērojat</b> dokumentu PrivateGPT, mēs <i>automātiski</i> sinhronizēsim jūsu dokumenta saturu no tā sākotnējā avota regulāros intervālos. Tas automātiski atjauninās saturu katrā darba vietā, kur šis fails tiek pārvaldīts.",
    ...
    "gitea": {
      "name": "Gitea Repo",
      "description": "Ievietojiet visu publisko vai privāto repozitāru no jebkuras Gitea instancē vienā darbībā.",
      "URL": "Gitea repozitorija URL",
      "URL_explained": "Veidotā repozitāra URL, ko vēlaties izveidot savā Gitea instancē – atbalstītas arī pašnomājās instalācijas.",
      "token": "Gitea piekļuves atslēga",
      "optional": "pēc izvēles",
      "token_explained": "Nepieciešams piekļuves tokens, lai iegūtu privātus repozitārus vai repozitārus, kas atrodas serveros, kur nepieciešama autentifikācija.",
      "token_explained_start": "Bez",
      "token_explained_link1": "Piekļuves tokens",
      "token_explained_end": "Tikai tie repozitāri, kas ir pieejami jūsu Gitea instalācijas izmantošanai, var tikt apkopoti.",
      "ignores": "Faila ignorēšana",
      "git_ignore": "Saraksts formātā `.gitignore`, kas paredzēts, lai ignorētu specifiskus failus, kad tiek veikta kolekcija. Nospiediet Enter pēc katra ieraksta, ko vēlaties saglabāt.",
      "task_explained": "Kad visi faili būs saglabāti, tie būs pieejami, lai tos varētu ievietot darba vietās dokumentu izvēlēšanās funkcijā.",
      "branch": "Pasta mape, no kuras vēlaties izveidot kopijas.",
      "branch_loading": "— Pārbaudes pieejamos veidus —",
      "branch_explained": "Pasta darbvietu, no kuras vēlaties lejupielādēt failus.",
      "token_information": "Bez aizpildot <b>Gitea piekļuves atslēgu</b>, šis datu savienojums varēs vēlēt tikai failus no repozitāriem, kas ir <b>atvērti un pieejami</b> jūsu Gitea instancē."
    }
  },
  "chat_window": {
    ...
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          ...
          "description": "Pirms satura publicēšanas ir jāiespējo autentifikācija \"PrivateGPT\" sabiedrības centrā.",
  ...
  "security": {
    ...
    "password": {
      ...
      "description": "Aizsargājiet savu PrivateGPT instanci ar paroli. Ja aizmirsīsiet šo paroli, nav atgūšanas metodes, tāpēc pārliecinieties, ka saglabājat šo paroli.",
  ...
  "telegram": {
    "title": "Telegram bot",
    "description": "Iespējiet savu PrivateGPT instanci, lai varētu tikt savienots ar Telegram, un tāpēc varēsat runāt ar saviem darba grupām no jebkura ierīces.",
    "setup": {
      "step1": {
  ...
  "imageGeneration": {
    ...
    "description": "Iestatiet pakalpojumu, ko izmanto attēlu ģenerēšanai no `/img` komandas.",
    ...
    "pending": {
      ...
      "description": "Tam varbūt būs nepieciešams laiks. Tas tiks publicēts šeit, kad tas būs gatavs.",
