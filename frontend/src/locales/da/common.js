...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT kan arbejde med mange LLM-udbydere. Dette vil være den tjeneste, der håndterer chat.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Hjælp os med at gøre PrivateGPT tilpasset dine behov. Valgfrit.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Aktiver ubegrænsede værktøjer og reducer brugen af cut-tokens med op til 80 % pr. forespørgsel – PrivateGPT vælger automatisk de relevante færdigheder til hver forespørgsel.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  api: {
    title: "API-nøgler",
    description:
      "API-nøgler giver indehaveren mulighed for programmatisk at få adgang til og administrere denne PrivateGPT-instans.",
    ...
    modal: {
      ...
      helper:
        "Når API-nøglen er oprettet, kan den bruges til programmatisk at få adgang til og konfigurere denne PrivateGPT-instans.",
      name: {
        label: "Navn",
  ...
  llm: {
    title: "LLM-præference",
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for din foretrukne LLM chat- og indlejringsudbyder. Det er vigtigt, at disse nøgler er opdaterede og korrekte, ellers vil PrivateGPT ikke fungere korrekt.",
  ...
  transcription: {
    ...
    "warn-start":
      "Brug af den lokale whisper-model på maskiner med begrænset RAM eller CPU kan få PrivateGPT til at gå i stå under behandling af mediefiler.",
  ...
  embedding: {
    ...
    "desc-end":
      "Indlejring er processen med at omdanne tekst til vektorer. Disse legitimationsoplysninger er nødvendige for at omdanne dine filer og prompts til et format, som PrivateGPT kan bruge til behandling.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Disse er legitimationsoplysningerne og indstillingerne for, hvordan din PrivateGPT-instans vil fungere. Det er vigtigt, at disse nøgler er opdaterede og korrekte.",
    provider: {
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Disse filer vil blive uploadet til dokumentbehandleren, der kører på denne PrivateGPT-instans. Filene sendes ikke eller deles med en tredjepart.",
    },
    pinning: {
      what_pinning: "Hvad er dokumentfastlåsning?",
      pin_explained_block1:
        "Når du <b>fastlåser</b> et dokument i PrivateGPT, vil vi indsætte hele dokumentets indhold i din prompt-vindue, så din LLM kan forstå det fuldt ud.",
      pin_explained_block2:
        "Dette fungerer bedst med <b>store kontekstmodeller</b> eller små filer, der er kritiske for dens vidensbase.",
      pin_explained_block3:
        "Hvis du ikke får de svar, du ønsker fra PrivateGPT som standard, er fastlåsning en fremragende måde at få svar af højere kvalitet med et enkelt klik.",
      accept: "Okay, jeg har forstået",
    },
    watching: {
      what_watching: "Hvad gør det at overvåge et dokument?",
      watch_explained_block1:
        "Når du <b>overvåger</b> et dokument i PrivateGPT, vil vi <i>automatisk</i> synkronisere dokumentets indhold fra dets oprindelige kilde med jævne mellemrum. Dette vil automatisk opdatere indholdet i alle arbejdsområder, hvor denne fil administreres.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Hukommelse",
        placeholder:
          "f.eks. Brugerens navn er Joe, brugeren arbejder med PrivateGPT, osv.",
        create: "Opret",
        save: "Gem",
        cancel: "Annullér",
      },
  ...
  customization: {
    ...
    items: {
      ...
      "display-language": {
        title: "Visningssprog",
        description:
          "Vælg det foretrukne sprog til at vise PrivateGPT's brugergrænseflade i – når oversættelser er tilgængelige.",
      },
      logo: {
        title: "Brand Logo",
        description:
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Beskyt din PrivateGPT-instans med en adgangskode. Hvis du glemmer den, findes der ingen genoprettelsesmetode, så sørg for at gemme denne adgangskode.",
  ...
  telegram: {
    title: "Telegram-bot",
    description:
      "Forbind dit PrivateGPT-instans med Telegram, så du kan kommunikere med dine arbejdsområder fra enhver enhed.",
    setup: {
      step1: {
