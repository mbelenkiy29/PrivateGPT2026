...
const TRANSLATIONS = {
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        ...
        "description": "اسمح للمتخصص بإنشاء مهام متكررة وفقًا للجدول الزمني المحدد من خلال الدردشة (مثل: \"كل يوم عمل في الساعة 9 صباحًا، قم بتلخيص صندوق بريدي وإرسال رسالة لي\"). متاح فقط في وضع المستخدم الواحد."
      }
    },
    "mcp": {
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        ...
        "description": "تمكين استخدام أدوات غير محدودة وتقليل استخدام رموز القطع بنسبة تصل إلى 80٪ لكل استعلام - يقوم PrivateGPT تلقائيًا باختيار المهارات المناسبة لكل طلب.",
        "max-tools": {
          "title": "أدوات ماكس",
  ...
  "api": {
    ...
    "modal": {
      ...
      "helper": "بمجرد إنشائه، يمكن استخدام مفتاح API للوصول إلى مثيل PrivateGPT هذا وإدارته برمجيًا.",
      "name": {
        "label": "الاسم",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "سيتم تحميل هذه الملفات إلى معالج المستندات الذي يعمل على هذه نسخة من PrivateGPT. هذه الملفات لا يتم إرسالها أو مشاركتها مع طرف ثالث."
    },
    "pinning": {
      "what_pinning": "ما هو عمل \"تثبيت المستندات\"؟",
      "pin_explained_block1": "عندما تقوم بإرفاق مستند في PrivateGPT، سنقوم بإدخال محتوى المستند بالكامل في نافذة المطالبة الخاصة بـ LLM الخاص بك، وذلك حتى يتمكن LLM من فهم المحتوى بالكامل.",
      "pin_explained_block2": "يعمل هذا بشكل أفضل مع **نماذج ذات سياق كبير** أو ملفات صغيرة ولكنها ضرورية لأساس المعرفة الخاص بها.",
      "pin_explained_block3": "إذا لم تحصل على الإجابات التي ترغب بها بشكل افتراضي من PrivateGPT، فإن استخدام ميزة \"التثبيت\" هو طريقة رائعة للحصول على إجابات ذات جودة أعلى في نقرة واحدة.",
      "accept": "حسناً، فهمت."
    },
    "watching": {
      "what_watching": "ما الذي يفعله مشاهدة فيلم وثائقي؟",
      "watch_explained_block1": "عندما **تشاهد** مستندًا في PrivateGPT، سيتم **مزامنة** محتوى المستند تلقائيًا من مصدره الأصلي على فترات منتظمة. وهذا سيؤدي إلى تحديث المحتوى تلقائيًا في كل مساحة عمل حيث يتم إدارة هذا الملف.",
    ...
    "gitea": {
      "name": "مستودع Gitea",
      "description": "استيراد مستودع كامل، سواء كان عامًا أو خاصًا، من أي خادم Gitea بنقرة واحدة فقط.",
      "URL": "عنوان مستودع Gitea",
      "URL_explained": "عنوان المستودع الذي ترغب في استنساخه على خادم Gitea الخاص بك – يتم دعم الخوادم التي تستضيفها بنفسك.",
      "token": "رمز الوصول إلى Gitea",
      "optional": "اختياري",
      "token_explained": "يجب الحصول على رمز الوصول لجمع المستودعات الخاصة أو المستودعات الموجودة على الخوادم التي تتطلب المصادقة.",
      "token_explained_start": "بدون",
      "token_explained_link1": "رمز الوصول",
      "token_explained_end": "، يمكن جمع البيانات فقط من المستودعات التي تعرضها نسخة Gitea الخاصة بك علنًا.",
      "ignores": "يتجاهل الملف",
      "git_ignore": "قم بإنشاء قائمة بتنسيق \".gitignore\" لتجاهل الملفات المحددة أثناء عملية الاستنساخ. اضغط على مفتاح الإدخال بعد كل إدخال ترغب في حفظه.",
      "task_explained": "بمجرد الانتهاء، ستكون جميع الملفات متاحة لإدراجها في مساحات العمل ضمن أداة اختيار المستندات.",
      "branch": "الفرع الذي ترغب في استرجاع الملفات منه.",
      "branch_loading": "– تحميل الفروع المتاحة –",
      "branch_explained": "الفرع الذي ترغب في استرجاع الملفات منه.",
      "token_information": "بدون إدخال رمز الوصول <b> الخاص بـ Gitea، فإن هذا الموصل للبيانات سيكون قادرًا فقط على جمع الملفات من المستودعات التي يمكن قراءتها بشكل <b> علني على مثيل Gitea الخاص بك."
    }
  },
  "chat_window": {
    ...
    "memories": {
      ...
      "modal": {
        ...
        "label": "الذاكرة",
        "placeholder": "على سبيل المثال: اسم المستخدم هو \"جو\"، المستخدم يعمل على برنامج \"PrivateGPT\"، إلخ.",
        "create": "إنشاء",
        "save": "احفظ",
        "cancel": "إلغاء"
      }
  ...
  "customization": {
    ...
    "branding": {
      ...
      "description": "قم بتخصيص نسخة PrivateGPT الخاصة بك باستخدام العلامات التجارية الخاصة بك."
    },
    "chat": {
      "title": "دردشة",
    ...
    "items": {
      ...
      "display-language": {
        ...
        "description": "حدد اللغة المفضلة لعرض واجهة مستخدم PrivateGPT - عند توفر الترجمات."
      },
      "logo": {
      ...
      "disable-auto-scroll": {
        ...
        "description": "تعطيل التمرير التلقائي إلى أسفل نافذة الدردشة عند استلام رسائل جديدة."
      }
    }
  },
  "main-page": {
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "يتطلب التحقق",
          "description": "يجب عليك التحقق من هويتك مع مركز مجتمع PrivateGPT قبل نشر أي محتوى.",
