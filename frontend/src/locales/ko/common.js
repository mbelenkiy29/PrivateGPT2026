...
const TRANSLATIONS = {
  "onboarding": {
    ...
    "llm": {
      "title": "LLM 기본 설정",
      "description": "PrivateGPT은 다양한 LLM 제공자와 연동할 수 있습니다. 여기서 선택한 서비스가 채팅을 담당하게 됩니다."
    },
    "userSetup": {
      "title": "사용자 설정",
    ...
    "data": {
      ...
      "description": "PrivateGPT은 여러분의 개인정보에 대한 투명성과 제어권을 최우선으로 생각합니다.",
      "settingsHint": "이 설정은 언제든지 설정 메뉴에서 다시 변경할 수 있습니다."
    },
    "survey": {
      "title": "PrivateGPT에 오신 것을 환영합니다",
      "description": "여러분의 필요에 맞는 PrivateGPT을 만들 수 있도록 도와주세요. (선택 사항)",
      "email": "이메일을 입력해 주세요",
      "useCase": "PrivateGPT을 어떤 용도로 사용하실 예정인가요?",
      "useCaseWork": "업무용",
      "useCasePersonal": "개인용",
      "useCaseOther": "기타",
      "comment": "PrivateGPT을 어떻게 알게 되셨나요?",
  ...
  "common": {
    ...
    "no": "아니오",
    "search": "검색",
    "username_requirements": "사용자 이름은 2-64자여야 하고, 소문자로 시작해야 하며, 소문자, 숫자, 밑줄, 하이픈, 마침표만 포함할 수 있습니다.",
    "on": "~에 대해",
    "none": "없음",
    "stopped": "멈춤",
    "loading": "로딩 중",
  ...
  "agent": {
    ...
    "skill": {
      ...
      "scheduledJob": {
        "title": "일정 기반 작업 생성",
        "description": "대행자가 채팅을 통해 반복적인 예약 작업을 생성할 수 있도록 합니다(예: \"매주 평일 오전 9시에 받은 이메일을 요약하여 제 이메일 주소로 보내기\"). 단독 사용자 모드에서만 사용 가능합니다."
      }
    },
    "mcp": {
      "title": "MCP 서버",
    ...
    "settings": {
      ...
      "intelligent-skill-selection": {
        "title": "지능형 기술 선택",
        "description": "쿼리당 무제한의 도구 사용 및 컷 토큰 사용량을 최대 80%까지 줄일 수 있습니다 – PrivateGPT은 모든 프롬프트에 적합한 기술을 자동으로 선택합니다.",
        "max-tools": {
          "title": "맥스 툴스",
  ...
  "customization": {
    "interface": {
      "title": "UI 환경 설정",
      "description": "PrivateGPT의 UI 환경을 원하는 대로 설정하세요."
    },
    "branding": {
      "title": "브랜딩 및 화이트라벨링",
      "description": "PrivateGPT 인스턴스에 맞춤 브랜딩을 적용해 화이트라벨링할 수 있습니다."
    },
    "chat": {
      "title": "채팅",
      "description": "PrivateGPT의 채팅 환경을 원하는 대로 설정하세요.",
      "auto_submit": {
        "title": "음성 입력 자동 전송",
    ...
    "items": {
      ...
      "display-language": {
        "title": "표시 언어",
        "description": "PrivateGPT의 UI에 사용할 언어를 선택하세요. 번역이 제공되는 경우에만 적용됩니다."
      },
      "logo": {
        "title": "브랜드 로고",
      ...
      "disable-auto-scroll": {
        "title": "자동 스크롤 기능 끄기",
        "description": "새 메시지가 도착할 때 자동으로 채팅 내용이 맨 아래로 스크롤되는 기능을 비활성화합니다."
      }
    }
  },
  "api": {
    "title": "API 키",
    "description": "API 키는 소유자가 프로그래밍 방식으로 이 PrivateGPT 인스턴스에 액세스하고 관리할 수 있도록 합니다.",
    "link": "API 문서 읽기",
    "generate": "새 API 키 생성",
    ...
    "modal": {
      ...
      "close": "닫기",
      "create": "API 키 만들기",
      "helper": "생성된 API 키는 이 PrivateGPT 인스턴스에 프로그래밍 방식으로 접근하고 구성하는 데 사용할 수 있습니다.",
      "name": {
        "label": "이름",
        "placeholder": "프로덕션 통합",
  ...
  "llm": {
    "title": "LLM 기본 설정",
    "description": "이것은 채팅과 임베딩을 하기 위한 선호하는 LLM 제공자의 인증입니다. 이 키가 현재 활성 상태이고 정확해야 PrivateGPT이 제대로 작동합니다.",
    "provider": "LLM 제공자",
    "providers": {
      "azure_openai": {
  ...
  "transcription": {
    ...
    "provider": "텍스트 변환 제공자",
    "warn-start": "RAM 또는 CPU 성능이 제한된 머신에서 로컬 위스퍼 모델을 사용하면 미디어 파일을 처리할 때 PrivateGPT이 중단될 수 있습니다.",
  ...
  "embedding": {
    ...
    "desc-end": "임베딩은 텍스트를 벡터로 변환하는 과정입니다. 파일과 프롬프트를 PrivateGPT이 처리할 수 있는 형식으로 변환하려면 이러한 인증이 필요합니다.",
    "provider": {
      "title": "임베딩 제공자"
    }
  },
  ...
  "vector": {
    "title": "벡터 데이터베이스",
    "description": "이것은 PrivateGPT 인스턴스가 벡터 데이터베이스 사용을 위한 인증 설정입니다. 이 키가 활성 상태이고 정확해야 합니다.",
    "provider": {
      "title": "벡터 데이터베이스 제공자",
  ...
  "privacy": {
    "title": "개인정보와 데이터 처리",
    "description": "연결된 타사 제공자와 PrivateGPT이 데이터를 처리하는 방식을 구성합니다.",
  ...
  "connectors": {
    ...
    "upload": {
      ...
      "privacy-notice": "이 파일들은 이 PrivateGPT 인스턴스에서 실행 중인 문서 처리기로 업로드됩니다. 파일은 제3자에게 전송되거나 공유되지 않습니다."
    },
    "pinning": {
      "what_pinning": "문서 고정이란 무엇인가요?",
      "pin_explained_block1": "PrivateGPT에서 문서를 <b>고정</b>하면 해당 문서의 전체 내용을 프롬프트 창에 삽입하여 LLM이 완전히 이해할 수 있도록 합니다.",
    ...
    "watching": {
      ...
      "watch_explained_block1": "PrivateGPT에서 문서를 <b>감시</b>하면 원본 소스에서 정기적으로 문서 내용을 <i>자동으로</i> 동기화합니다. 이 파일이 관리되는 모든 워크스페이스의 내용이 자동으로 업데이트됩니다.",
    ...
    "gitea": {
      "name": "기테아 저장소",
      "description": "어떤 Gitea 인스턴스에서든 전체 공개 또는 사내 저장소를 단일 클릭으로 가져올 수 있습니다.",
      "URL": "Gitea 저장소 URL",
      "URL_explained": "수집하려는 저장소의 URL (자체 호스팅된 Gitea 인스턴스에 적용)",
      "token": "Gitea 접근 토큰",
      "optional": "선택 사항",
      "token_explained": "개인 저장소 또는 인증이 필요한 인스턴스의 저장소를 수집하려면 액세스 토큰이 필요합니다.",
      "token_explained_start": "(어떤 것) 없이",
      "token_explained_link1": "액세스 토큰",
      "token_explained_end": "Gitea 인스턴스가 공개적으로 노출하는 저장소만 수집할 수 있습니다.",
      "ignores": "파일 무시",
      "git_ignore": "수집 시 특정 파일을 무시하도록 `.gitignore` 형식으로 목록을 작성합니다. 저장하려는 항목마다 엔터를 누르세요.",
      "task_explained": "모든 파일이 완료되면, 문서 선택기에서 워크스페이스에 삽입할 수 있습니다.",
      "branch": "파일을 가져올 서버 또는 브랜치를 선택하세요.",
      "branch_loading": "– 사용 가능한 브랜치 로딩 중 –",
      "branch_explained": "파일을 가져올 서버를 선택하세요.",
      "token_information": "<b>Gitea 접근 토큰</b>을 입력하지 않으면, 이 데이터 연결기는 귀하의 Gitea 인스턴스에서 <b>공개적으로 읽을 수 있는</b> 저장소에서만 파일을 수집할 수 있습니다."
    }
  },
  "chat_window": {
  ...
  "community_hub": {
    "publish": {
      ...
      "generic": {
        "unauthenticated": {
          "title": "인증 필요",
          "description": "항목을 게시하려면 PrivateGPT 커뮤니티 허브에 인증해야 합니다.",
          "button": "커뮤니티 허브에 연결"
        }
      }
    }
  ...
  "security": {
    ...
    "password": {
      "title": "비밀번호 보호",
      "description": "PrivateGPT 인스턴스를 비밀번호로 보호하십시오. 이 비밀번호를 잊어버리면 복구 방법이 없으므로 반드시 저장하세요.",
  ...
  "imageGeneration": {
    "title": "이미지 생성 선호도",
    "description": "`/img` 명령어를 사용하여 이미지를 생성하는 데 사용되는 제공 업체를 구성합니다.",
    ...
    "pending": {
      "heading": "이미지 생성 중...",
      "description": "이 작업에는 시간이 걸릴 수 있습니다. 준비되면 바로 여기에서 확인하실 수 있습니다.",
