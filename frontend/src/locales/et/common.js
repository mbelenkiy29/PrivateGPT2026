...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "PrivateGPT töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Aita meil PrivateGPT sinu vajadustele vastavaks kujundada. Valikuline.",
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – PrivateGPT valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles PrivateGPT UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda PrivateGPT instantsi.",
    ...
    modal: {
      ...
      create: "Loo API võti",
      helper:
        "Pärast loomist saab API võtit kasutada sellele PrivateGPT-i instantsile programmiga ligi pääsemiseks ja selle seadistamiseks.",
      name: {
        label: "Nimi",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul PrivateGPT ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et PrivateGPT saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas PrivateGPT töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mälestus",
        placeholder:
          "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes PrivateGPT jne.",
        create: "Loo",
        save: "Salvesta",
        cancel: "Katkuda\nTühista",
      },
  ...
  telegram: {
    title: "Telegrami bot",
    description:
      "Ühendage oma PrivateGPT instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    setup: {
      step1: {
